<?php
namespace ElementorAvator\Modules\Posts\Widgets;

use Elementor\Core\Schemes;
use Elementor\Group_Control_Image_Size;
use Elementor\Group_Control_Typography;
use ElementorAvator\Base\Base_Widget;
use ElementorAvator\Modules\QueryControl\Module as Module_Query;
...
class Portfolio extends Base_Widget {
	...
	public function get_title() {
		return __( 'Portfolio', 'elementor-avator' );
	}
	...
	private function register_query_section_controls() {
		...
		$this->add_control(
			'item_ratio',
			[
				'label' => __( 'Item Ratio', 'elementor-avator' ),
		...
		$this->add_control(
			'show_title',
			[
				'label' => __( 'Show Title', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_off' => __( 'Off', 'elementor-avator' ),
				'label_on' => __( 'On', 'elementor-avator' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Items', 'elementor-avator' ),
		...
		$this->add_control(
			'item_gap',
			[
				'label' => __( 'Item Gap', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Item Overlay', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'color_filter_active',
			[
				'label' => __( 'Active Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Schemes\Color::get_type(),
	...
	protected function render_filter_menu() {
		...
		<ul class="elementor-portfolio__filters">
			<li class="elementor-portfolio__filter elementor-active" data-filter="__all"><?php echo __( 'All', 'elementor-avator' ); ?></li>
