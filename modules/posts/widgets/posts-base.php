...
abstract class Posts_Base extends Base_Widget {
	...
	public function register_pagination_section_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'prev_next' => __( 'Previous/Next', 'elementor-avator' ),
					'numbers_and_prev_next' => __( 'Numbers', 'elementor-avator' ) . ' + ' . __( 'Previous/Next', 'elementor-avator' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Page Limit', 'elementor-avator' ),
				'default' => '5',
				'condition' => [
					'pagination_type!' => '',
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Shorten', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( '&laquo; Previous', 'elementor-avator' ),
				'condition' => [
					'pagination_type' => [
						'prev_next',
						'numbers_and_prev_next',
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Next &raquo;', 'elementor-avator' ),
				'condition' => [
					'pagination_type' => [
						'prev_next',
						'numbers_and_prev_next',
