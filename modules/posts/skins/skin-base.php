...
abstract class Skin_Base extends Elementor_Skin_Base {
	...
	protected function register_thumbnail_controls() {
		$this->add_control(
			'thumbnail',
			[
				'label' => __( 'Image Position', 'elementor-avator' ),
		...
		$this->add_control(
			'masonry',
			[
				'label' => __( 'Masonry', 'elementor-avator' ),
		...
		$this->add_responsive_control(
			'item_ratio',
			[
				'label' => __( 'Image Ratio', 'elementor-avator' ),
		...
		$this->add_responsive_control(
			'image_width',
			[
				'label' => __( 'Image Width', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'%' => [
						'min' => 10,
	...
	protected function register_excerpt_controls() {
		$this->add_control(
			'show_excerpt',
			[
				'label' => __( 'Excerpt', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'elementor-avator' ),
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'default' => 'yes',
		...
		$this->add_control(
			'excerpt_length',
			[
				'label' => __( 'Excerpt Length', 'elementor-avator' ),
				'type' => Controls_Manager::NUMBER,
	...
	protected function register_read_more_controls() {
		$this->add_control(
			'show_read_more',
			[
				'label' => __( 'Read More', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'elementor-avator' ),
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'default' => 'yes',
		...
		$this->add_control(
			'read_more_text',
			[
				'label' => __( 'Read More Text', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Read More »', 'elementor-avator' ),
				'condition' => [
	...
	protected function register_link_controls() {
		$this->add_control(
			'open_new_tab',
			[
				'label' => __( 'Open in new window', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
	...
	protected function register_meta_data_controls() {
		...
		$this->add_control(
			'meta_separator',
			[
				'label' => __( 'Separator Between', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => '///',
				'selectors' => [
	...
	protected function register_design_content_controls() {
		...
		$this->add_control(
			'heading_meta_style',
			[
				'label' => __( 'Meta', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					$this->get_control_id( 'meta_data!' ) => [],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Separator Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function render_loop_footer() {
		...
		if ( $has_numbers ) {
			$paginate_args = [
				...
				'before_page_number' => '<span class="elementor-screen-only">' . __( 'Page', 'elementor-avator' ) . '</span>',
			];
		...
		?>
		<nav class="elementor-pagination" role="navigation" aria-label="<?php esc_attr_e( 'Pagination', 'elementor-avator' ); ?>">
