...
class Facebook_Page extends Base_Widget {
	...
	public function get_title() {
		return esc_html__( 'Facebook Page', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'description' => __( 'Paste the URL of the Facebook page.', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'timeline' => __( 'Timeline', 'elementor-avator' ),
					'events' => __( 'Events', 'elementor-avator' ),
					'messages' => __( 'Messages', 'elementor-avator' ),
				],
			]
		);
		...
		$this->add_control(
			'small_header',
			[
				'label' => __( 'Small Header', 'elementor-avator' ),
		...
		$this->add_control(
			'show_cover',
			[
				'label' => __( 'Cover Photo', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'show_facepile',
			[
				'label' => __( 'Profile Photos', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_control(
			'show_cta',
			[
				'label' => __( 'Custom CTA Button', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
