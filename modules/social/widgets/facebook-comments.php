...
class Facebook_Comments extends Base_Widget {
	...
	public function get_title() {
		return __( 'Facebook Comments', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Comments Box', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'comments_number',
			[
				'label' => __( 'Comment Count', 'elementor-avator' ),
				'type' => Controls_Manager::NUMBER,
				'min' => 5,
				'max' => 100,
				'default' => '10',
				'description' => __( 'Minimum number of comments: 5', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'social',
				'options' => [
					'social' => __( 'Social', 'elementor-avator' ),
					'reverse_time' => __( 'Reverse Time', 'elementor-avator' ),
