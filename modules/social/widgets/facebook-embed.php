...
class Facebook_Embed extends Base_Widget {
	...
	public function get_title() {
		return __( 'Facebook Embed', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_content',
			[
				'label' => __( 'Embed', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'post',
				'options' => [
					'post' => __( 'Post', 'elementor-avator' ),
					'video' => __( 'Video', 'elementor-avator' ),
					'comment' => __( 'Comment', 'elementor-avator' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Hover over the date next to the post, and copy its link address.', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Hover over the date next to the video, and copy its link address.', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Hover over the date next to the comment, and copy its link address.', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'include_parent',
			[
				'label' => __( 'Parent Comment', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'description' => __( 'Set to include parent comment (if URL is a reply).', 'elementor-avator' ),
				'condition' => [
					'type' => 'comment',
				],
			]
		...
		$this->add_control(
			'show_text',
			[
				'label' => __( 'Full Post', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'description' => __( 'Show the full text of the post', 'elementor-avator' ),
				'condition' => [
					'type' => [ 'post', 'video' ],
				],
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Allow Full Screen', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'condition' => [
					'type' => 'video',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'description' => __( 'Show captions if available (only on desktop).', 'elementor-avator' ),
				'condition' => [
					'type' => 'video',
				],
			]
	...
	public function render() {
		...
		if ( empty( $settings['type'] ) ) {
			esc_html_e( 'Please set the embed type', 'elementor-avator' );
		...
		if ( 'comment' === $settings['type'] && empty( $settings['comment_url'] ) || 'post' === $settings['type'] && empty( $settings['post_url'] ) || 'video' === $settings['type'] && empty( $settings['video_url'] ) ) {
			esc_html_e( 'Please enter a valid URL', 'elementor-avator' );
