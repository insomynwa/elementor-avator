<?php
namespace ElementorAvator\Modules\ThemeBuilder;
...
use ElementorAvator\Modules\ThemeBuilder\Classes;
use ElementorAvator\Modules\ThemeBuilder\Documents\Single;
...
class Module extends Module_Base {
	...
	public function get_widgets() {
		...
		if ( class_exists( '\ElementorAvator\Modules\Posts\Widgets\Posts' ) ) {
	...
	public function localize_settings( $settings ) {
		...
		$settings = array_replace_recursive( $settings, [
			'i18n' => [
				'publish_settings' => __( 'Publish Settings', 'elementor-avator' ),
				'conditions' => __( 'Conditions', 'elementor-avator' ),
				'display_conditions' => __( 'Display Conditions', 'elementor-avator' ),
				'choose' => __( 'Choose', 'elementor-avator' ),
				'add_condition' => __( 'Add Condition', 'elementor-avator' ),
				'conditions_title' => sprintf( __( 'Where Do You Want to Display Your %s?', 'elementor-avator' ), $document->get_post_type_title() ),
				'conditions_description' => sprintf( __( 'Set the conditions that determine where your %s is used throughout your site.', 'elementor-avator' ), $document->get_post_type_title() ) . '<br>' . __( 'For example, choose \'Entire Site\' to display the template across your site.', 'elementor-avator' ),
				'conditions_publish_screen_description' => __( 'Apply current template to these pages.', 'elementor-avator' ),
				'save_and_close' => __( 'Save & Close', 'elementor-avator' ),
			],
			'theme_builder' => [
	...
	public function print_post_type_field() {
		...
		<div id="elementor-new-template__form__post-type__wrapper" class="elementor-form-field">
			<label for="elementor-new-template__form__post-type" class="elementor-form-field__label">
				<?php echo __( 'Select Post Type', 'elementor-avator' ); ?>
			</label>
			<div class="elementor-form-field__select__wrapper">
				<select id="elementor-new-template__form__post-type" class="elementor-form-field__select" name="<?php echo Single::REMOTE_CATEGORY_META_KEY; ?>">
					...
					// 404.
					echo sprintf( '<option value="%1$s">%2$s</option>', 'not_found404', __( '404 Page', 'elementor-avator' ) );
	...
	public function add_finder_items( array $categories ) {
		$categories['general']['items']['theme-builder'] = [
			'title' => __( 'Theme Builder', 'elementor-avator' ),
			'icon' => 'library-save',
		...
		$categories['create']['items']['theme-template'] = [
			'title' => __( 'Add New Theme Template', 'elementor-avator' ),
			'icon' => 'plus-circle-o',
	...
	public function admin_menu() {
		add_submenu_page( Source_Local::ADMIN_MENU_SLUG, '', __( 'Theme Builder', 'elementor-avator' ), 'publish_posts', $this->get_admin_templates_url( true ) );
	}
