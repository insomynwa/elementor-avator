...
<script type="text/template" id="tmpl-elementor-theme-builder-conditions-view">
	<div class="elementor-template-library-blank-icon">
		<img src="<?php echo ELEMENTOR_AVATOR_MODULES_URL; ?>theme-builder/assets/images/conditions-tab.svg">
	</div>
	<div class="elementor-template-library-blank-title">{{{ elementorAvator.translate( 'conditions_title', [ elementor.config.document.post_type_title ] ) }}}</div>
	<div class="elementor-template-library-blank-message">{{{ elementorAvator.translate( 'conditions_description', [ elementor.config.document.post_type_title ] ) }}}</div>
...
<script type="text/template" id="tmpl-elementor-theme-builder-conditions-repeater-row">
	...
	<div class="elementor-repeater-row-tool elementor-repeater-tool-remove">
		...
		<span class="elementor-screen-only"><?php esc_html_e( 'Remove this item', 'elementor-avator' ); ?></span>
	</div>
</script>

<script type="text/template" id="tmpl-elementor-theme-builder-button-preview">
	<i class="eicon-preview-medium tooltip-target" aria-hidden="true"  data-tooltip="<?php esc_attr_e( 'Preview Changes', 'elementor-avator' ); ?>"></i>
	<span class="elementor-screen-only">
		<?php esc_attr_e( 'Preview Changes', 'elementor-avator' ); ?>
	</span>
	<div class="elementor-panel-footer-sub-menu-wrapper">
		...
		<div onclick="$e.run( 'theme-builder-publish/preview-settings' );" id="elementor-panel-footer-theme-builder-button-preview-settings" class="elementor-panel-footer-sub-menu-item">
				...
				<span class="elementor-title"><?php esc_html_e( 'Settings', 'elementor-avator' ); ?></span>
			</div>
			<div onclick="$e.run( 'editor/documents/preview', { id: elementor.documents.getCurrent().id, force: true } );" id="elementor-panel-footer-theme-builder-button-open-preview" class="elementor-panel-footer-sub-menu-item">
				...
				<span class="elementor-title"><?php esc_html_e( 'Preview', 'elementor-avator' ); ?></span>
			</div>
		</div>
	</div>
</script>
