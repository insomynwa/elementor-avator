...
<script type="text/template" id="tmpl-elementor-theme-builder-conditions-view">
	...
	<div class="elementor-template-library-blank-title">{{{ elementorAvator.translate( 'conditions_title' ) }}}</div>
	<div class="elementor-template-library-blank-message">{{{ elementorAvator.translate( 'conditions_description' ) }}}</div>
