...
abstract class Theme_Page_Document extends Theme_Document {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'page_template',
			[
				'label' => __( 'Page Layout', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Default', 'elementor-avator' ),
					PageTemplatesModule::TEMPLATE_CANVAS => __( 'Elementor Canvas', 'elementor-avator' ),
					PageTemplatesModule::TEMPLATE_HEADER_FOOTER => __( 'Elementor Full Width', 'elementor-avator' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( 'Default Page Template from your theme', 'elementor-avator' ),
				'separator' => 'none',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'No header, no footer, just Elementor', 'elementor-avator' ),
				'separator' => 'none',
				'content_classes' => 'elementor-descriptor',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'This template includes the header, full-width content and footer', 'elementor-avator' ),
				'separator' => 'none',
				'content_classes' => 'elementor-descriptor',
				'condition' => [
