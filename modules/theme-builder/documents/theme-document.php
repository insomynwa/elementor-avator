...
abstract class Theme_Document extends Library_Document {
	...
	public function get_location_label() {
		...
		if ( ! $supported ) {
			$label .= ' (' . __( 'Unsupported', 'elementor-avator' ) . ')';
		}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'preview_settings',
			[
				'label' => __( 'Preview Settings', 'elementor-avator' ),
		...
		$this->add_control(
			'preview_type',
			[
				'label' => __( 'Preview Dynamic Content as', 'elementor-avator' ),
				'label_block' => true,
		...
		$this->add_control(
			'preview_search_term',
			[
				'label' => __( 'Search Term', 'elementor-avator' ),
				'export' => false,
				'condition' => [
					'preview_type' => 'search',
				],
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Apply & Preview', 'elementor-avator' ),
				'label_block' => true,
				'show_label' => false,
				'text' => __( 'Apply & Preview', 'elementor-avator' ),
				'separator' => 'none',
