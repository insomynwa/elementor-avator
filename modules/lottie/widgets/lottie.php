...
namespace ElementorAvator\Modules\Lottie\Widgets;
...
class Lottie extends Base_Widget {
	...
	public function get_title() {
		return __( 'Lottie', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section( 'lottie', [
			'label' => __( 'Lottie', 'elementor-avator' )
		] );
		...
		$this->add_control(
			...
			[
				...
				'default' => 'media_file',
				'options' => [
					'media_file' => __( 'Media File', 'elementor-avator' ),
					'external_url' => __( 'External URL', 'elementor-avator' ),
				],
		...
		$this->add_control(
			'source_external_url',
			[
				'label' => __( 'External URL', 'elementor-avator' ),
				...
				'placeholder' => __( 'Enter your URL', 'elementor-avator' ),
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'source_json',
			[
				'label' => __( 'Upload JSON File', 'elementor-avator' ),
		...
		$this->add_control(
			'caption_source',
			[
				'label' => __( 'Caption', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => [
		...
		$this->add_control(
			...
			[
				...
				'render_type' => 'none',
				'default' => '',
				'placeholder' => __( '', 'elementor-avator' ),
				'conditions' => [
					'relation' => 'or',
					'terms' => [
						[
		...
		$this->start_controls_section( 'settings', [
			'label' => __( 'Settings', 'elementor-avator' )
		] );

		$this->add_control(
			'trigger',
			[
				'label' => __( 'Trigger', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'arriving_to_viewport',
				'options' => [
					'arriving_to_viewport' => __( 'Viewport', 'elementor-avator' ),
					'on_click' => __( 'On Click', 'elementor-avator' ),
					'on_hover' => __( 'On Hover', 'elementor-avator' ),
					'bind_to_scroll' => __( 'Scroll', 'elementor-avator' ),
					'none' => __( 'None', 'elementor-avator' ),
				],
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'viewport',
			[
				'label' => __( 'Viewport', 'elementor-avator' ),
				...
				'labels' => [
					__( 'Bottom', 'elementor-avator' ),
					__( 'Top', 'elementor-avator' ),
				],
				'scales' => 1,
				'handles' => 'range',
				'frontend_available' => true,
		...
		$this->add_control(
			'effects_relative_to',
			[
				'label' => __( 'Effects Relative to', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'render_type' => 'none',
				'condition' => [
				...
				'default' => 'viewport',
				'options' => [
					'viewport' => __( 'Viewport', 'elementor-avator' ),
					'page' => __( 'Entire Page', 'elementor-avator' ),
				],
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'loop',
			[
				'label' => __( 'Loop', 'elementor-avator' ),
		...
		$this->add_control(
			'number_of_times',
			[
				'label' => __( 'Number of Times', 'elementor-avator' ),
		...
		$this->add_control(
			'reverse_animation',
			[
				'label' => __( 'Reverse Animation', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'render_type' => 'none',
				'conditions' => [
					'relation' => 'and',
		...
		$this->add_control(
			'link_timeout',
			[
				'label' => __( 'Link Timeout (ms)', 'elementor-avator' ),
				'type' => Controls_Manager::NUMBER,
				'render_type' => 'none',
				'conditions' => [
					'relation' => 'and',
				...
				'description' => __( 'Redirect to link after selected timeout', 'elementor-avator' ),
				'min' => 0,
				'max' => 5000,
				'step' => 1,
				'frontend_available' => true,
		...
		$this->add_control(
			'on_hover_out',
			[
				'label' => __( 'On Hover Out', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'render_type' => 'none',
				'condition' => [
					'trigger' => 'on_hover',
				...
				'options' => [
					...
					'reverse' => __( 'Reverse', 'elementor-avator' ),
					'pause' => __( 'Pause', 'elementor-avator' ),
				],
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'hover_area',
			[
				'label' => __( 'Hover Area', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'render_type' => 'none',
				'condition' => [
					'trigger' => 'on_hover',
				...
				'default' => 'animation',
				'options' => [
					'animation' => __( 'Animation', 'elementor-avator' ),
					'column' => __( 'Column', 'elementor-avator' ),
					'section' => __( 'Section', 'elementor-avator' ),
				],
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			'renderer',
			[
				'label' => __( 'Renderer', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'svg',
				'options' => [
					'svg' => __( 'SVG', 'elementor-avator' ),
					'canvas' => __( 'Canvas', 'elementor-avator' ),
				],
				'separator' => 'before',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'lazyload',
			[
				'label' => __( 'Lazyload', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => '',
				'frontend_available' => true,
