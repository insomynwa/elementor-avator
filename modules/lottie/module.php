...
namespace ElementorAvator\Modules\Lottie;
...
class Module extends Module_Base {
	...
	public function register_frontend_scripts() {
		...
		wp_register_script(
			'lottie',
			ELEMENTOR_AVATOR_URL . 'assets/lib/lottie/lottie' . $suffix . '.js',
			[
				'jquery',
			],
			'5.6.6',
	...
	public function localize_settings( array $settings ) {
		$settings['lottie']['defaultAnimationUrl'] = ELEMENTOR_AVATOR_MODULES_URL . 'lottie/assets/animations/default.json';
