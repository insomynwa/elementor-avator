...
class Group_Control_Posts extends Group_Control_Base {
	...
	protected function prepare_fields( $fields ) {
		...
		$post_types_options['by_id'] = __( 'Manual Selection', 'elementor-avator' );
		$post_types_options['current_query'] = __( 'Current Query', 'elementor-avator' );
	...
	public function get_query_args( $control_id_prefix, $settings ) {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters( 'elementor_avator/query_control/get_query_args/current_query', $current_query_vars );
