...
class Elementor_Post_Query {
	...
	public function get_query_args() {
		...
		if ( 'current_query' === $post_type ) {
			 ...
			 */
			$current_query_vars = apply_filters_deprecated( 'elementor_avator/query_control/get_query_args/current_query', [ $current_query_vars ], '2.5.0', 'elementor/query/get_query_args/current_query' );
	...
	public function pre_get_posts_query_filter( $wp_query ) {
		if ( $this->widget ) {
			...
			/**
			 * Elementor Avator posts widget Query args.
			 *
			 ...
			 */
			do_action_deprecated( "elementor_avator/{$widget_name}/query/{$query_id}", [ $wp_query, $this->widget ], '2.5.0', "elementor/query/{$query_id}" );
