<?php
namespace ElementorAvator\Modules\Library;

use Elementor\Core\Base\Document;
use Elementor\TemplateLibrary\Source_Local;
use ElementorAvator\Base\Module_Base;
use ElementorAvator\Modules\Library\Classes\Shortcode;
...
class Module extends Module_Base {
	...
	public function register_wp_widgets() {
		register_widget( 'ElementorAvator\Modules\Library\WP_Widgets\Elementor_Library' );
	}
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, [
			'i18n' => [
				'home_url' => home_url(),
				'edit_template' => __( 'Edit Template', 'elementor-avator' ),
			],
		] );
	...
	public function add_filters() {
		...
		add_filter( 'elementor_avator/admin/localize_settings', [ $this, 'localize_settings' ] ); // For WordPress Widgets and Customizer
		add_filter( 'elementor/widgets/black_list', function( $black_list ) {
			$black_list[] = 'ElementorAvator\Modules\Library\WP_Widgets\Elementor_Library';

			return $black_list;
		} );
		/**
		 * @deprecated 2.6.0 The following filters will be removed in Elementor Avator 2.9.0:
		 */
		add_filter( 'elementor_avator/query_control/get_autocomplete/library_widget_templates', [ $this, 'get_autocomplete_for_library_widget_templates' ], 10, 2 );
		add_filter( 'elementor_avator/query_control/get_value_titles/library_widget_templates', [ $this, 'get_value_title_for_library_widget_templates' ], 10, 2 );
	}
	...
	public static function empty_templates_message() {
		return '<div id="elementor-widget-template-empty-templates">
				...
				<div class="elementor-widget-template-empty-templates-title">' . __( 'You Haven’t Saved Templates Yet.', 'elementor-avator' ) . '</div>
				<div class="elementor-widget-template-empty-templates-footer">' . __( 'Want to learn more about Elementor library?', 'elementor-avator' ) . ' <a class="elementor-widget-template-empty-templates-footer-url" href="https://go.elementor.com/docs-library/" target="_blank">' . __( 'Click Here', 'elementor-avator' ) . '</a>
				</div>
				</div>';
	}
}
