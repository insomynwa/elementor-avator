<?php
namespace ElementorAvator\Modules\Library\Widgets;
...
class Template extends Base_Widget {
	...
	public function get_title() {
		return __( 'Template', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_template',
			[
				'label' => __( 'Template', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'template_id',
			[
				'label' => __( 'Choose Template', 'elementor-avator' ),
