<?php
namespace ElementorAvator\Modules\Library\WP_Widgets;

use Elementor\Core\Base\Document;
use ElementorAvator\Modules\Library\Module;
...
class Elementor_Library extends \WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			'elementor-library',
			esc_html__( 'Elementor Library', 'elementor-avator' ),
			[
				'description' => esc_html__( 'Embed your saved elements.', 'elementor-avator' ),
			]
		);
	}
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title', 'elementor-avator' ); ?>:</label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>">
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'template_id' ) ); ?>"><?php esc_attr_e( 'Choose Template', 'elementor-avator' ); ?>:</label>
			<select class="widefat elementor-widget-template-select" id="<?php echo esc_attr( $this->get_field_id( 'template_id' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'template_id' ) ); ?>">
				<option value="">— <?php _e( 'Select', 'elementor-avator' ); ?> —</option>
				<?php
			...
			<a target="_blank" class="elementor-edit-template"<?php echo $style; ?> href="<?php echo esc_url( add_query_arg( 'elementor', '', get_permalink( $instance['template_id'] ) ) ); ?>">
				<i class="eicon-pencil"></i> <?php echo __( 'Edit Template', 'elementor-avator' ); ?>
			</a>
		</p>
		<?php
	}
