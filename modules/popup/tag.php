...
use ElementorAvator\Modules\DynamicTags\Tags\Base\Tag as DynamicTagsTag;
use ElementorAvator\Modules\DynamicTags\Module as DynamicTagsModule;
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'toggle' => __( 'Toggle Popup', 'elementor-avator' ),
				],
			]
		);
