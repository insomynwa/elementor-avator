...
use ElementorAvator\Modules\ThemeBuilder\Classes\Locations_Manager;
...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_action( 'elementor_avator/init', [ $this, 'add_form_action' ] );
	...
	public static function add_popup_to_location( $popup_id ) {
		/** @var \ElementorAvator\Modules\ThemeBuilder\Module $theme_builder */
	...
	public function register_ajax_actions( Ajax $ajax ) {
		$ajax->register_ajax_action( 'avator_popup_save_display_settings', [ $this, 'save_display_settings' ] );
	}

	public function localize_settings( array $settings ) {
		$settings = array_replace_recursive( $settings, [
			'i18n' => [
				'popups' => __( 'Popups', 'elementor-avator' ),
				'triggers' => __( 'Triggers', 'elementor-avator' ),
				'timing' => __( 'Advanced Rules', 'elementor-avator' ),
				'popup_publish_screen_triggers_description' => __( 'What action the user needs to do for the popup to open.', 'elementor-avator' ),
				'popup_publish_screen_timing_description' => __( 'Requirements that have to be met for the popup to open.', 'elementor-avator' ),
				'popup_settings_introduction_title' => __( 'Please Note', 'elementor-avator' ),
				'popup_settings_introduction_message' => __( 'Popup settings are accessed via the settings icon in the bottom menu', 'elementor-avator' ),
			],
		] );
	...
	public function admin_menu() {
		add_submenu_page( Source_Local::ADMIN_MENU_SLUG, '', __( 'Popups', 'elementor-avator' ), 'publish_posts', $this->get_admin_url( true ) );
	}

	public function add_finder_items( array $categories ) {
		$categories['general']['items']['popups'] = [
			'title' => __( 'Popups', 'elementor-avator' ),
			'icon' => 'library-save',
		...
		$categories['create']['items']['popups'] = [
			'title' => __( 'Add New Popup', 'elementor-avator' ),
			'icon' => 'plus-circle-o',
