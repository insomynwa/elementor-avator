...
class Honeypot_Handler {
	...
	public function add_field_type( $field_types ) {
		$field_types['honeypot'] = __( 'Honeypot', 'elementor-avator' );
	...
	public function validation( $record, $ajax_handler ) {
		...
		if ( ! empty( $field['value'] ) ) {
			$ajax_handler->add_error( $field['id'], __( 'Invalid Form.', 'elementor-avator' ) );
		}
	...
	public function __construct() {
		...
		add_action( 'elementor_avator/forms/render/item', [ $this, 'hide_label' ], 10, 3 );
		add_action( 'elementor_avator/forms/render_field/honeypot', [ $this, 'render_field' ], 10, 3 );
