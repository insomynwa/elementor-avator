<?php
namespace ElementorAvator\Modules\Forms\Actions;
...
class Email extends Action_Base {
	...
	public function get_label() {
		return __( 'Email', 'elementor-avator' );
	}
	...
	public function register_settings_section( $widget ) {
		...
		$widget->add_control(
			...
			[
				'label' => __( 'To', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => get_option( 'admin_email' ),
				'placeholder' => get_option( 'admin_email' ),
				'label_block' => true,
				'title' => __( 'Separate emails with commas', 'elementor-avator' ),
				'render_type' => 'none',
			]
		);

		/* translators: %s: Site title. */
		$default_message = sprintf( __( 'New message from "%s"', 'elementor-avator' ), get_option( 'blogname' ) );
		...
		$widget->add_control(
			...
			[
				...
				'description' => sprintf( __( 'By default, all form fields are sent via %s shortcode. To customize sent fields, copy the shortcode that appears inside each field and paste it above.', 'elementor-avator' ), '<code>[all-fields]</code>' ),
				'render_type' => 'none',
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'From Email', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
			...
			[
				'label' => __( 'From Name', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Reply-To', 'elementor-avator' ),
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Meta Data', 'elementor-avator' ),
				...
				'options' => [
					...
					'page_url' => __( 'Page URL', 'elementor-avator' ),
					'user_agent' => __( 'User Agent', 'elementor-avator' ),
					'remote_ip' => __( 'Remote IP', 'elementor-avator' ),
					'credit' => __( 'Credit', 'elementor-avator' ),
				],
				'render_type' => 'none',
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Send As', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'html',
				'render_type' => 'none',
				'options' => [
	...
	/**
	 * @param \ElementorAvator\Modules\Forms\Classes\Form_Record  $record
	 * @param \ElementorAvator\Modules\Forms\Classes\Ajax_Handler $ajax_handler
	 */
	public function run( $record, $ajax_handler ) {
		...
		$fields = [
			...
			/* translators: %s: Site title. */
			'email_subject' => sprintf( __( 'New message from "%s"', 'elementor-avator' ), get_bloginfo( 'name' ) ),
		 ...
		 */
		$headers = apply_filters( 'elementor_avator/forms/wp_mail_headers', $headers );
		 ...
		 */
		$fields['email_content'] = apply_filters( 'elementor_avator/forms/wp_mail_message', $fields['email_content'] );
		 ...
		 */
		do_action( 'elementor_avator/forms/mail_sent', $settings, $record );
