...
class Mailpoet3 extends Action_Base {
	...
	public function register_settings_section( $widget ) {
		$widget->start_controls_section(
			'section_mailpoet3',
			[
				'label' => __( 'MailPoet 3', 'elementor-avator' ),
				'condition' => [
		...
		$mailpoet_fields = [
			[
				...
				'remote_label' => __( 'First Name', 'elementor-avator' ),
				'remote_type' => 'text',
			],
			[
				'remote_id' => 'last_name',
				'remote_label' => __( 'Last Name', 'elementor-avator' ),
				'remote_type' => 'text',
			],
			[
				'remote_id' => 'email',
				'remote_label' => __( 'Email', 'elementor-avator' ),
				'remote_type' => 'email',
