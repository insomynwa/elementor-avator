...
class Webhook extends Action_Base {
	...
	public function get_label() {
		return __( 'Webhook', 'elementor-avator' );
	}
	...
	public function register_settings_section( $widget ) {
		$widget->start_controls_section(
			'section_webhook',
			[
				'label' => __( 'Webhook', 'elementor-avator' ),
				'condition' => [
		...
		$widget->add_control(
			...
			[
				...
				'placeholder' => __( 'https://your-webhook-url.com', 'elementor-avator' ),
				'label_block' => true,
				'separator' => 'before',
				'description' => __( 'Enter the integration URL (like Zapier) that will receive the form\'s submitted data.', 'elementor-avator' ),
				'render_type' => 'none',
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Advanced Data', 'elementor-avator' ),
	...
	public function run( $record, $ajax_handler ) {
		 ...
		 */
		$args = apply_filters( 'elementor_avator/forms/webhooks/request_args', $args, $record );
		 ...
		 * @param Form_Record     $record   An instance of the form record.
		 */
		do_action( 'elementor_avator/forms/webhooks/response', $response, $record );
