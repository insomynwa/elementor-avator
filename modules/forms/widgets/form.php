<?php
namespace ElementorAvator\Modules\Forms\Widgets;
...
use ElementorAvator\Modules\Forms\Classes\Ajax_Handler;
use ElementorAvator\Modules\Forms\Classes\Form_Base;
use ElementorAvator\Modules\Forms\Controls\Fields_Repeater;
use ElementorAvator\Modules\Forms\Module;
...
class Form extends Form_Base {
	...
	public function get_title() {
		return __( 'Form', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$field_types = [
			...
			'textarea' => __( 'Textarea', 'elementor-avator' ),
			'url' => __( 'URL', 'elementor-avator' ),
			'tel' => __( 'Tel', 'elementor-avator' ),
			'radio' => __( 'Radio', 'elementor-avator' ),
			'select' => __( 'Select', 'elementor-avator' ),
			'checkbox' => __( 'Checkbox', 'elementor-avator' ),
			'acceptance' => __( 'Acceptance', 'elementor-avator' ),
			'number' => __( 'Number', 'elementor-avator' ),
			'date' => __( 'Date', 'elementor-avator' ),
			'time' => __( 'Time', 'elementor-avator' ),
			'upload' => __( 'File Upload', 'elementor-avator' ),
			'password' => __( 'Password', 'elementor-avator' ),
			'html' => __( 'HTML', 'elementor-avator' ),
			'hidden' => __( 'Hidden', 'elementor-avator' ),
		];
		 ...
		 */
		$field_types = apply_filters( 'elementor_avator/forms/field_types', $field_types );
		...
		$repeater->add_control(
			'required',
			[
				'label' => __( 'Required', 'elementor-avator' ),
		...
		$repeater->add_control(
			'field_options',
			[
				'label' => __( 'Options', 'elementor-avator' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => '',
				'description' => __( 'Enter each option in a separate line. To differentiate between label and value, separate them with a pipe char ("|"). For example: First Name|f_name', 'elementor-avator' ),
				'conditions' => [
					'terms' => [
						[
							'name' => 'field_type',
		...
		$repeater->add_control(
			'allow_multiple',
			[
				'label' => __( 'Multiple Selection', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'true',
				'conditions' => [
					'terms' => [
		...
		$repeater->add_control(
			'select_size',
			[
				'label' => __( 'Rows', 'elementor-avator' ),
		...
		$repeater->add_control(
			'inline_list',
			[
				'label' => __( 'Inline List', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$repeater->add_control(
			'field_html',
			[
				'label' => __( 'HTML', 'elementor-avator' ),
				'type' => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
		...
		$repeater->add_responsive_control(
			'width',
			[
				'label' => __( 'Column Width', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'Default', 'elementor-avator' ),
					'100' => '100%',
					'80' => '80%',
					'75' => '75%',
					'66' => '66%',
		...
		$repeater->add_control(
			'recaptcha_size', [
				...
				'default' => 'normal',
				'options' => [
					'normal' => __( 'Normal', 'elementor-avator' ),
					'compact' => __( 'Compact', 'elementor-avator' ),
				],
				'conditions' => [
					'terms' => [
						[
		...
		$repeater->add_control(
			'recaptcha_badge', [
				...
				'default' => 'bottomright',
				'options' => [
					'bottomright' => __( 'Bottom Right', 'elementor-avator' ),
					'bottomleft' => __( 'Bottom Left', 'elementor-avator' ),
					'inline' => __( 'Inline', 'elementor-avator' ),
				],
				'description' => __( 'To view the validation badge, switch to preview mode', 'elementor-avator' ),
				'conditions' => [
					'terms' => [
						[
							'name' => 'field_type',
		...
		$repeater->add_control(
			'field_value',
			[
				'label' => __( 'Default Value', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'dynamic' => [
					'active' => true,
		...
		$repeater->add_control(
			'custom_id',
			[
				'label' => __( 'ID', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'description' => __( 'Please make sure the ID is unique and not used elsewhere in this form. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'elementor-avator' ),
				'render_type' => 'none',
			]
		);
		...
		$repeater->add_control(
			'shortcode',
			[
				'label' => __( 'Shortcode', 'elementor-avator' ),
		...
		$this->start_controls_section(
			'section_form_fields',
			[
				'label' => __( 'Form Fields', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'form_name',
			[
				'label' => __( 'Form Name', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'New Form', 'elementor-avator' ),
				'placeholder' => __( 'Form Name', 'elementor-avator' ),
			]
		);
			...
			[
				...
				'default' => [
					[
						'custom_id' => 'name',
						'field_type' => 'text',
						'field_label' => __( 'Name', 'elementor-avator' ),
						'placeholder' => __( 'Name', 'elementor-avator' ),
						'width' => '100',
					],
					[
						'custom_id' => 'email',
						'field_type' => 'email',
						'required' => 'true',
						'field_label' => __( 'Email', 'elementor-avator' ),
						'placeholder' => __( 'Email', 'elementor-avator' ),
						'width' => '100',
					],
					[
						'custom_id' => 'message',
						'field_type' => 'textarea',
						'field_label' => __( 'Message', 'elementor-avator' ),
						'placeholder' => __( 'Message', 'elementor-avator' ),
						'width' => '100',
					],
				],
		...
		$this->add_control(
			'input_size',
			[
				'label' => __( 'Input Size', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
		...
		$this->add_control(
			'mark_required',
			[
				'label' => __( 'Required Mark', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'elementor-avator' ),
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'default' => '',
		...
		$this->add_control(
			'label_position',
			[
				'label' => __( 'Label Position', 'elementor-avator' ),
				'type' => Controls_Manager::HIDDEN,
				'options' => [
					'above' => __( 'Above', 'elementor-avator' ),
					'inline' => __( 'Inline', 'elementor-avator' ),
				],
				'default' => 'above',
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Step Buttons', 'elementor-avator' ),
		...
		$this->add_control(
			'step_next_label',
			[
				'label' => __( 'Next', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'frontend_available' => true,
				'render_type' => 'none',
				'default' => __( 'Next', 'elementor-avator' ),
				'placeholder' => __( 'Next', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'step_previous_label',
			[
				'label' => __( 'Previous', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'frontend_available' => true,
				'render_type' => 'none',
				'default' => __( 'Previous', 'elementor-avator' ),
				'placeholder' => __( 'Previous', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Submit Button', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			'button_text',
			[
				'label' => __( 'Submit', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Send', 'elementor-avator' ),
				'placeholder' => __( 'Send', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'button_icon_align',
			[
				'label' => __( 'Icon Position', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'left',
				'options' => [
					'left' => __( 'Before', 'elementor-avator' ),
					'right' => __( 'After', 'elementor-avator' ),
				],
				'condition' => [
		...
		$this->add_control(
			'button_icon_indent',
			[
				'label' => __( 'Icon Spacing', 'elementor-avator' ),
		...
		$this->add_control(
			'button_css_id',
			[
				'label' => __( 'Button ID', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'title' => __( 'Add your custom id WITHOUT the Pound key. e.g: my-id', 'elementor-avator' ),
				'description' => __( 'Please make sure the ID is unique and not used elsewhere on the page this form is displayed. This field allows <code>A-z 0-9</code> & underscore chars without spaces.', 'elementor-avator' ),
				'separator' => 'before',
		...
		$this->start_controls_section(
			'section_integration',
			[
				'label' => __( 'Actions After Submit', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'submit_actions',
			[
				'label' => __( 'Add Action', 'elementor-avator' ),
				...
				'description' => __( 'Add actions that will be performed after a visitor submits the form (e.g. send an email notification). Choosing an action will add its setting below.', 'elementor-avator' ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Steps Settings', 'elementor-avator' ),
		...
		$this->add_control(
			'step_icon_shape',
			[
				'label' => __( 'Shape', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'frontend_available' => true,
				'render_type' => 'none',
				'options' => [
		...
		$repeater->add_control(
			'display_percentage',
			[
				'label' => __( 'Display Percentage', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'frontend_available' => true,
				'render_type' => 'none',
				'return_value' => 'true',
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Additional Options', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_CONTENT,
			]
		);
		...
		$this->add_control(
			'form_id',
			[
				'label' => __( 'Form ID', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'custom_messages',
			[
				'label' => __( 'Custom Messages', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'separator' => 'before',
				'render_type' => 'none',
		...
		$this->add_control(
			'success_message',
			[
				'label' => __( 'Success Message', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'error_message',
			[
				'label' => __( 'Error Message', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Required Message', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'invalid_message',
			[
				'label' => __( 'Invalid Message', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->start_controls_section(
			'section_form_style',
			[
				'label' => __( 'Form', 'elementor-avator' ),
		...
		$this->add_control(
			'column_gap',
			[
				'label' => __( 'Columns Gap', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 10,
				],
		...
		$this->add_control(
			'row_gap',
			[
				'label' => __( 'Rows Gap', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 10,
				],
		...
		$this->add_control(
			'mark_required_color',
			[
				'label' => __( 'Mark Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'heading_html',
			[
				'label' => __( 'HTML Field', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Next & Submit Button', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Previous Button', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
			]
		);
		...
		$this->add_control(
			'button_text_padding',
			[
				'label' => __( 'Text Padding', 'elementor-avator' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Messages', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Success Message Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'error_message_color',
			[
				'label' => __( 'Error Message Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Inline Message Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_steps_style',
			[
				'label' => __( 'Steps', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Inactive', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Primary Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'scheme' => [
					'type' => Schemes\Color::get_type(),
					'value' => Schemes\Color::COLOR_3,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Secondary Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Completed', 'elementor-avator' ),
			]
		);
		...
		$this->add_responsive_control(
			'step_divider_width',
			[
				'label' => __( 'Divider Width', 'elementor-avator' ),
				'separator' => 'before',
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
		...
		$this->add_responsive_control(
			'step_divider_gap',
			[
				'label' => __( 'Divider Gap', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 10,
					'unit' => 'px',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Percentage', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'step_type' => 'progress_bar',
	...
	protected function render() {
		...
		if ( ! Plugin::elementor()->editor->is_edit_mode() ) {
			 ...
			 */
			do_action( 'elementor-avator/forms/pre_render', $instance, $this );
		}
		...
		<form class="elementor-form" method="post" <?php echo $this->get_render_attribute_string( 'form' ); ?>>
			...
			<div <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
				...
				foreach ( $instance['form_fields'] as $item_index => $item ) :
					 ...
					 */
					$item = apply_filters( 'elementor_avator/forms/render/item', $item, $item_index, $this );
					 ...
					 * @param Form  $this       An instance of the form.
					 */
					$item = apply_filters( "elementor_avator/forms/render/item/{$field_type}", $item, $item_index, $this );
				...
				<div <?php echo $this->get_render_attribute_string( 'field-group' . $item_index ); ?>>
					...
					switch ( $item['field_type'] ) :
						...
						default:
							 ...
							 * @param Form  $this       An instance of the form.
							 */
							do_action( "elementor_avator/forms/render_field/{$field_type}", $item, $item_index, $this );
					endswitch;
					?>
				</div>
				<?php endforeach; ?>
							...
							<?php if ( ! empty( $instance['button_icon'] ) || ! empty( $instance['selected_button_icon'] ) ) : ?>
								<span <?php echo $this->get_render_attribute_string( 'icon-align' ); ?>>
									...
									<?php if ( empty( $instance['button_text'] ) ) : ?>
										<span class="elementor-screen-only"><?php _e( 'Submit', 'elementor-avator' ); ?></span>
									<?php endif; ?>
								</span>
							<?php endif; ?>
							<?php if ( ! empty( $instance['button_text'] ) ) : ?>
	...
	protected function content_template() {
		$submit_text = esc_html__( 'Submit', 'elementor-avator' );
		?>
			...
			<div class="elementor-form-fields-wrapper elementor-labels-{{settings.label_position}}">
				<#
					for ( var i in settings.form_fields ) {
						...
						item = elementor.hooks.applyFilters( 'elementor_avator/forms/content_template/item', item, i, settings );
						...
						switch ( item.field_type ) {
							...
							case 'search':
								...
								break;
							default:
								inputField = elementor.hooks.applyFilters( 'elementor_avator/forms/content_template/field/' + item.field_type, '', item, i, settings );
						}
