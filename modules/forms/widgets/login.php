...
class Login extends Base_Widget {
	...
	public function get_title() {
		return __( 'Login', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Log In', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Redirect After Login', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
		...
		$this->add_control(
			...
			[
				...
				'description' => __( 'Note: Because of security reasons, you can ONLY use your current domain here.', 'elementor-avator' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Redirect After Logout', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'label_off' => __( 'Off', 'elementor-avator' ),
				'label_on' => __( 'On', 'elementor-avator' ),
		...
		$this->add_control(
			'show_lost_password',
			[
				'label' => __( 'Lost your password?', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'label_on' => __( 'Show', 'elementor-avator' ),
		...
		if ( get_option( 'users_can_register' ) ) {
			$this->add_control(
				'show_register',
				[
					'label' => __( 'Register', 'elementor-avator' ),
					'type' => Controls_Manager::SWITCHER,
					'default' => 'yes',
					'label_off' => __( 'Hide', 'elementor-avator' ),
					'label_on' => __( 'Show', 'elementor-avator' ),
		...
		$this->add_control(
			'show_remember_me',
			[
				'label' => __( 'Remember Me', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'label_on' => __( 'Show', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Logged in Message', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'label_on' => __( 'Show', 'elementor-avator' ),
		...
		$this->add_control(
			'user_label',
			[
				'label' => __( 'Username Label', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( ' Username or Email Address', 'elementor-avator' ),
				'condition' => [
					'show_labels' => 'yes',
					'custom_labels' => 'yes',
				],
		...
		$this->add_control(
			'user_placeholder',
			[
				'label' => __( 'Username Placeholder', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( ' Username or Email Address', 'elementor-avator' ),
				'condition' => [
					'custom_labels' => 'yes',
		...
		$this->add_control(
			'password_label',
			[
				'label' => __( 'Password Label', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Password', 'elementor-avator' ),
				'condition' => [
					'show_labels' => 'yes',
					'custom_labels' => 'yes',
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Password Placeholder', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Password', 'elementor-avator' ),
				'condition' => [
					'custom_labels' => 'yes',
		...
		$this->add_control(
			'links_color',
			[
				'label' => __( 'Links Color', 'elementor-avator' ),
		...
		$this->add_control(
			'links_hover_color',
			[
				'label' => __( 'Links Hover Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_field_style',
			[
				'label' => __( 'Fields', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		if ( is_user_logged_in() && ! Plugin::elementor()->editor->is_edit_mode() ) {
			if ( 'yes' === $settings['show_logged_in_message'] ) {
				...
				echo '<div class="elementor-login elementor-login__logged-in-message">' .
					sprintf( __( 'You are Logged in as %1$s (<a href="%2$s">Logout</a>)', 'elementor-avator' ), $current_user->display_name, wp_logout_url( $logout_redirect ) ) .
					'</div>';
			}
				...
				<?php if ( 'yes' === $settings['show_remember_me'] ) : ?>
					<div class="elementor-field-type-checkbox elementor-field-group elementor-column elementor-col-100 elementor-remember-me">
						<label for="elementor-login-remember-me">
							...
							<?php echo __( 'Remember Me', 'elementor-avator' ); ?>
						</label>
					</div>
				<?php endif; ?>
					...
					<div class="elementor-field-group elementor-column elementor-col-100">
						<?php if ( $show_lost_password ) : ?>
							<a class="elementor-lost-password" href="<?php echo wp_lostpassword_url( $redirect_url ); ?>">
								<?php echo __( 'Lost your password?', 'elementor-avator' ); ?>
							</a>
						<?php endif; ?>
						...
						<?php if ( $show_register ) : ?>
							...
							<a class="elementor-register" href="<?php echo wp_registration_url(); ?>">
								<?php echo __( 'Register', 'elementor-avator' ); ?>
							</a>
						<?php endif; ?>
					</div>
				<?php endif; ?>
