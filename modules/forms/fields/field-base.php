...
abstract class Field_Base {
	...
	public function __construct() {
		...
		add_action( "elementor_avator/forms/render_field/{$field_type}", [ $this, 'field_render' ], 10, 3 );
		add_action( "elementor_avator/forms/validation/{$field_type}", [ $this, 'validation' ], 10, 3 );
		add_action( "elementor_avator/forms/process/{$field_type}", [ $this, 'process_field' ], 10, 3 );
		add_filter( 'elementor_avator/forms/field_types', [ $this, 'add_field_type' ] );
		add_filter( "elementor_avator/forms/sanitize/{$field_type}", [ $this, 'sanitize_field' ], 10, 2 );
