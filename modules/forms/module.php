<?php
namespace ElementorAvator\Modules\Forms;

use Elementor\Core\Common\Modules\Ajax\Module as Ajax;
use ElementorAvator\Base\Module_Base;
use ElementorAvator\Modules\Forms\Actions;
use ElementorAvator\Modules\Forms\Classes;
use ElementorAvator\Modules\Forms\Fields;
...
class Module extends Module_Base {
	/**
	 * @var \ElementorAvator\Modules\Forms\Classes\Action_Base[]
	 */
	private $form_actions = [];
	/**
	 * @var \ElementorAvator\Modules\Forms\Fields\Field_Base[]
	 */
	public $field_types = [];
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, [
			'i18n' => [
				'x_field' => __( '%s Field', 'elementor-avator' ),
			],
		] );
	...
	public function forms_panel_action_data( array $data ) {
		...
		/** @var \ElementorAvator\Modules\Forms\Classes\Integration_Base $integration */
	...
	public function register_ajax_actions( Ajax $ajax ) {
		$ajax->register_ajax_action( 'avator_forms_panel_action_data', [ $this, 'forms_panel_action_data' ] );
	}
	...
	public function __construct() {
		...
		if ( Classes\Ajax_Handler::is_form_submitted() ) {
			 ...
			 */
			do_action( 'elementor_avator/forms/form_submitted', $this );
		}
	}
}
