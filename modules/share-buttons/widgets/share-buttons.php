<?php
namespace ElementorAvator\Modules\ShareButtons\Widgets;
...
use ElementorAvator\Modules\ShareButtons\Module;
...
class Share_Buttons extends Base_Widget {
	...
	public function get_title() {
		return __( 'Share Buttons', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Share Buttons', 'elementor-avator' ),
			]
		);
		...
		$repeater->add_control(
			'button',
			[
				'label' => __( 'Network', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				...
				'title_field' => '<i class="{{ elementorAvator.modules.shareButtons.getNetworkClass( button ) }}" aria-hidden="true"></i> {{{ elementorAvator.modules.shareButtons.getNetworkTitle( obj ) }}}',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'boxed' => __( 'Boxed Icon', 'elementor-avator' ),
					'flat' => __( 'Flat', 'elementor-avator' ),
				],
				'default' => 'gradient',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'rounded' => __( 'Rounded', 'elementor-avator' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => __( 'Justify', 'elementor-avator' ),
		...
		$this->add_responsive_control(
			'button_size',
			[
				'label' => __( 'Button Size', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0.5,
		...
		$this->add_responsive_control(
			'button_height',
			[
				'label' => __( 'Button Height', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'em' => [
						'min' => 1,
					...
					<div class="<?php echo esc_attr( $button_classes . $social_network_class ); ?>">
						<?php if ( 'icon' === $settings['view'] || 'icon-text' === $settings['view'] ) : ?>
							<span class="elementor-share-btn__icon">
								...
								<span class="elementor-screen-only"><?php echo sprintf( __( 'Share on %s', 'elementor-avator' ), $network_name ); ?></span>
							</span>
						<?php endif; ?>
						<?php if ( $show_text ) : ?>
