<?php
namespace ElementorAvator\Modules\ShareButtons;
...
class Module extends Module_Base {
	...
	public function __construct() {
		...
		add_filter( 'elementor_avator/frontend/localize_settings', [ $this, 'add_localize_data' ] );

		add_filter( 'elementor_avator/editor/localize_settings', [ $this, 'add_localize_data' ] );
