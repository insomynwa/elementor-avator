...
namespace ElementorAvator\Modules\MotionFX;
...
class Controls_Group extends Group_Control_Base {
	...
	protected function init_fields() {
		$fields = [
			'motion_fx_scrolling' => [
				'label' => __( 'Scrolling Effects', 'elementor-avator' ),
		...
		$fields['transform_origin_x'] = [
			'label' => __( 'X Anchor Point', 'elementor-avator' ),
		...
		$fields['transform_origin_y'] = [
			'label' => __( 'Y Anchor Point', 'elementor-avator' ),
			'type' => Controls_Manager::CHOOSE,
			'default' => 'center',
			'options' => [
				'top' => [
		...
		$fields['devices'] = [
			'label' => __( 'Apply Effects On', 'elementor-avator' ),
		...
		$fields['motion_fx_mouse'] = [
			'label' => __( 'Mouse Effects', 'elementor-avator' ),
			'type' => Controls_Manager::SWITCHER,
			'label_off' => __( 'Off', 'elementor-avator' ),
			'label_on' => __( 'On', 'elementor-avator' ),
			'separator' => 'before',
	...
	private function get_scrolling_effects() {
		return [
			'translateY' => [
				'label' => __( 'Vertical Scroll', 'elementor-avator' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'elementor-avator' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => __( 'Up', 'elementor-avator' ),
							'negative' => __( 'Down', 'elementor-avator' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'elementor-avator' ),
			...
			'translateX' => [
				'label' => __( 'Horizontal Scroll', 'elementor-avator' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'elementor-avator' ),
						'type' => Controls_Manager::SELECT,
						'options' => [
							'' => __( 'To Left', 'elementor-avator' ),
							'negative' => __( 'To Right', 'elementor-avator' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'elementor-avator' ),
			...
			'opacity' => [
				'label' => __( 'Transparency', 'elementor-avator' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'elementor-avator' ),
						'type' => Controls_Manager::SELECT,
					...
					'level' => [
						'label' => __( 'Level', 'elementor-avator' ),
						'type' => Controls_Manager::SLIDER,
						'default' => [
							'size' => 10,
						],
			...
			'blur' => [
				'label' => __( 'Blur', 'elementor-avator' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'elementor-avator' ),
						'type' => Controls_Manager::SELECT,
			...
			'rotateZ' => [
				'label' => __( 'Rotate', 'elementor-avator' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'elementor-avator' ),
						'type' => Controls_Manager::SELECT,
			...
			'scale' => [
				'label' => __( 'Scale', 'elementor-avator' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'elementor-avator' ),
						'type' => Controls_Manager::SELECT,
	...
	private function get_mouse_effects() {
		return [
			'mouseTrack' => [
				'label' => __( 'Mouse Track', 'elementor-avator' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'elementor-avator' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => __( 'Opposite', 'elementor-avator' ),
							'negative' => __( 'Direct', 'elementor-avator' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'elementor-avator' ),
			...
			'tilt' => [
				'label' => __( '3D Tilt', 'elementor-avator' ),
				'fields' => [
					'direction' => [
						'label' => __( 'Direction', 'elementor-avator' ),
						'type' => Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							'' => __( 'Direct', 'elementor-avator' ),
							'negative' => __( 'Opposite', 'elementor-avator' ),
						],
					],
					'speed' => [
						'label' => __( 'Speed', 'elementor-avator' ),
