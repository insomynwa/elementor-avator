...
class Archive_Products_Deprecated extends Products {
	...
	public function get_title() {
		return __( 'Archive Products (deprecated)', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->deprecated_notice( Plugin::get_title(), '2.5.0', '', __( 'Archive Products', 'elementor-avator' ) );
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( 'Note that these layout settings will override settings made in Appearance > Customize', 'elementor-avator' ),
