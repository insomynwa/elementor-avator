...
class Archive_Products extends Products {
	...
	public function get_title() {
		return __( 'Archive Products', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		if ( ! get_theme_support( 'woocommerce' ) ) {
			$this->add_control(
				...
				[
					...
					'raw' => __( 'Looks like you are using WooCommerce, while your theme does not support it. Please consider switching themes.', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'To change the Products Archive’s layout, go to Appearance > Customize.', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::RAW_HTML,
				'raw' => __( 'The editor preview might look different from the live site. Please make sure to check the frontend.', 'elementor-avator' ),
				'content_classes' => 'elementor-panel-alert elementor-panel-alert-warning',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Nothing Found Message', 'elementor-avator' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'It seems we can\'t find what you\'re looking for.', 'elementor-avator' ),
			]
		);
