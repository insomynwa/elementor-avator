...
use ElementorAvator\Modules\Woocommerce\Classes\Products_Renderer;
use ElementorAvator\Modules\Woocommerce\Classes\Current_Query_Renderer;
...
class Products extends Products_Base {
	...
	public function get_title() {
		return __( 'Products', 'elementor-avator' );
	}
	...
	protected function register_query_controls() {
		$this->start_controls_section(
			'section_query',
			[
				'label' => __( 'Query', 'elementor-avator' ),
				...
				'fields_options' => [
					'post_type' => [
						...
						'options' => [
							...
							'product' => __( 'Latest Products', 'elementor-avator' ),
							'sale' => __( 'Sale', 'elementor-avator' ),
							'featured' => __( 'Featured', 'elementor-avator' ),
							'by_id' => _x( 'Manual Selection', 'Posts Query Control', 'elementor-avator' ),
						],
					],
					'orderby' => [
						'default' => 'date',
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'paginate',
			[
				'label' => __( 'Pagination', 'elementor-avator' ),
		...
		$this->add_control(
			'allow_order',
			[
				'label' => __( 'Allow Order', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'condition' => [
					'paginate' => 'yes',
		...
		$this->add_control(
			...
			[
				...
				'raw' => __( 'Ordering is not available if this widget is placed in your front page. Visible on frontend only.', 'elementor-avator' ),
		...
		$this->add_control(
			'show_result_count',
			[
				'label' => __( 'Show Result Count', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'condition' => [
					'paginate' => 'yes',
