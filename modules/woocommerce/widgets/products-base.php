...
abstract class Products_Base extends Base_Widget {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'star_color',
			[
				'label' => __( 'Star Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'empty_star_color',
			[
				'label' => __( 'Empty Star Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'star_size',
			[
				'label' => __( 'Star Size', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'unit' => 'em',
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Regular Price', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			'sale_flash_style',
			[
				'label' => __( 'Sale Flash', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
