...
class Categories extends Widget_Base {
	...
	public function get_title() {
		return __( 'Product Categories', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'number',
			[
				'label' => __( 'Categories Count', 'elementor-avator' ),
				'type' => Controls_Manager::NUMBER,
				'default' => '4',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => __( 'Show All', 'elementor-avator' ),
					'by_id' => __( 'Manual Selection', 'elementor-avator' ),
					'by_parent' => __( 'By Parent', 'elementor-avator' ),
					'current_subcategories' => __( 'Current Subcategories', 'elementor-avator' ),
				],
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			'categories',
			[
				'label' => __( 'Categories', 'elementor-avator' ),
		...
		$parent_options = [ '0' => __( 'Only Top Level', 'elementor-avator' ) ] + $options;
		$this->add_control(
			'parent',
			[
				'label' => __( 'Parent', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => '0',
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'slug' => __( 'Slug', 'elementor-avator' ),
					'description' => __( 'Description', 'elementor-avator' ),
					'count' => __( 'Count', 'elementor-avator' ),
				],
			]
		);
