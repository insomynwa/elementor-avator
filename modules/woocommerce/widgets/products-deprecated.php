...
use ElementorAvator\Modules\Woocommerce\Skins;
...
class Products_Deprecated extends Products_Base {
	...
	public function get_title() {
		return __( 'Woo - Products-', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->deprecated_notice( Plugin::get_title(), '2.0.10', '', __( 'Products', 'elementor-avator' ) );
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' => __( 'Products Count', 'elementor-avator' ),
		...
		$this->add_control(
			'filter_by',
			[
				'label' => __( 'Filter By', 'elementor-avator' ),
