...
class Add_To_Cart extends Widget_Button {
	...
	public function get_title() {
		return __( 'Custom Add To Cart', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'show_quantity',
			[
				'label' => __( 'Show Quantity', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'label_on' => __( 'Show', 'elementor-avator' ),
				'description' => __( 'Please note that switching on this option will disable some of the design controls.', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'quantity',
			[
				'label' => __( 'Quantity', 'elementor-avator' ),
		...
		$this->update_control(
			'text',
			[
				'default' => __( 'Add to Cart', 'elementor-avator' ),
				'placeholder' => __( 'Add to Cart', 'elementor-avator' ),
			]
		);
	...
	private function render_ajax_button( $product ) {
		...
		if ( $product ) {
			...
			$settings['text'] = __( 'Please set a valid product', 'elementor-avator' );
	...
	private function render_form_button( $product ) {
		if ( ! $product && current_user_can( 'manage_options' ) ) {
			echo __( 'Please set a valid product', 'elementor-avator' );
