<?php
namespace ElementorAvator\Modules\Woocommerce\Documents;

use ElementorAvator\Modules\ThemeBuilder\Documents\Archive;
...
class Product_Archive extends Archive {
	...
	public static function get_properties() {
		...
		$propertyes['condition_type'] = 'product_archive';
	...
	public static function get_title() {
		return __( 'Product Archive', 'elementor-avator' );
	}
	...
	public static function get_preview_as_options() {
		...
		$post_type_archives[ 'post_type_archive/' . $post_type ] = $post_type_object->label . ' ' . __( 'Archive', 'elementor-avator' );
		...
		foreach ( $post_type_taxonomies as $slug => $object ) {
			$taxonomies[ 'taxonomy/' . $slug ] = $object->label . ' ' . __( 'Archive', 'elementor-avator' );
		}
	...
	protected static function get_editor_panel_categories() {
		$categories = [
			'woocommerce-elements-archive' => [
				'title' => __( 'Product Archive', 'elementor-avator' ),
			],
