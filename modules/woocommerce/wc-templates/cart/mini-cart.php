...
if ( ! function_exists( 'elementor_avator_render_mini_cart_item' ) ) {
	function elementor_avator_render_mini_cart_item( $cart_item_key, $cart_item ) {
		...
		<div class="elementor-menu-cart__product woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
			...
			<div class="elementor-menu-cart__product-name product-name" data-title="<?php esc_attr_e( 'Product', 'elementor-avator' ); ?>">
				<?php
				if ( ! $product_permalink ) :
			...
			<div class="elementor-menu-cart__product-price product-price" data-title="<?php esc_attr_e( 'Price', 'elementor-avator' ); ?>">
			...
			<div class="elementor-menu-cart__product-remove product-remove">
				...
				echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
					...
					__( 'Remove this item', 'elementor-avator' ),
					esc_attr( $product_id ),
...
if ( empty( $cart_items ) ) { ?>
	<div class="woocommerce-mini-cart__empty-message"><?php esc_attr_e( 'No products in the cart.', 'elementor-avator' ); ?></div>
<?php } else { ?>
	<div class="elementor-menu-cart__products woocommerce-mini-cart cart woocommerce-cart-form__contents">
		...
		foreach ( $cart_items as $cart_item_key => $cart_item ) {
			elementor_avator_render_mini_cart_item( $cart_item_key, $cart_item );
		}
