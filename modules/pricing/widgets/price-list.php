...
class Price_List extends Base_Widget {
	...
	public function get_title() {
		return __( 'Price List', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'price_list',
			[
				'label' => __( 'List Items', 'elementor-avator' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'title' => __( 'First item on the list', 'elementor-avator' ),
						'item_description' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'elementor-avator' ),
						'price' => '$20',
						'link' => [ 'url' => '#' ],
					],
					[
						'title' => __( 'Second item on the list', 'elementor-avator' ),
						'item_description' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'elementor-avator' ),
						'price' => '$9',
						'link' => [ 'url' => '#' ],
					],
					[
						'title' => __( 'Third item on the list', 'elementor-avator' ),
						'item_description' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'elementor-avator' ),
						'price' => '$32',
						'link' => [ 'url' => '#' ],
					],
		...
		$this->add_control(
			'heading__title',
			[
				'label' => __( 'Title & Price', 'elementor-avator' ),
		...
		$this->start_controls_section(
			'section_item_style',
			[
				'label' => __( 'Item', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
