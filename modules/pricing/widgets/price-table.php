<?php
namespace ElementorAvator\Modules\Pricing\Widgets;
...
class Price_Table extends Base_Widget {
	...
	public function get_title() {
		return __( 'Price Table', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_header',
			[
				'label' => __( 'Header', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Enter your title', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Enter your description', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'heading_tag',
			[
				'label' => __( 'Heading Tag', 'elementor-avator' ),
		...
		$this->start_controls_section(
			'section_pricing',
			[
				'label' => __( 'Pricing', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'currency_symbol',
			[
				'label' => __( 'Currency Symbol', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => __( 'None', 'elementor-avator' ),
					'dollar' => '&#36; ' . _x( 'Dollar', 'Currency Symbol', 'elementor-avator' ),
					'euro' => '&#128; ' . _x( 'Euro', 'Currency Symbol', 'elementor-avator' ),
					'baht' => '&#3647; ' . _x( 'Baht', 'Currency Symbol', 'elementor-avator' ),
					'franc' => '&#8355; ' . _x( 'Franc', 'Currency Symbol', 'elementor-avator' ),
					'guilder' => '&fnof; ' . _x( 'Guilder', 'Currency Symbol', 'elementor-avator' ),
					'krona' => 'kr ' . _x( 'Krona', 'Currency Symbol', 'elementor-avator' ),
					'lira' => '&#8356; ' . _x( 'Lira', 'Currency Symbol', 'elementor-avator' ),
					'peseta' => '&#8359 ' . _x( 'Peseta', 'Currency Symbol', 'elementor-avator' ),
					'peso' => '&#8369; ' . _x( 'Peso', 'Currency Symbol', 'elementor-avator' ),
					'pound' => '&#163; ' . _x( 'Pound Sterling', 'Currency Symbol', 'elementor-avator' ),
					'real' => 'R$ ' . _x( 'Real', 'Currency Symbol', 'elementor-avator' ),
					'ruble' => '&#8381; ' . _x( 'Ruble', 'Currency Symbol', 'elementor-avator' ),
					'rupee' => '&#8360; ' . _x( 'Rupee', 'Currency Symbol', 'elementor-avator' ),
					'indian_rupee' => '&#8377; ' . _x( 'Rupee (Indian)', 'Currency Symbol', 'elementor-avator' ),
					'shekel' => '&#8362; ' . _x( 'Shekel', 'Currency Symbol', 'elementor-avator' ),
					'yen' => '&#165; ' . _x( 'Yen/Yuan', 'Currency Symbol', 'elementor-avator' ),
					'won' => '&#8361; ' . _x( 'Won', 'Currency Symbol', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Custom Symbol', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
		...
		$this->add_control(
			'price',
			[
				'label' => __( 'Price', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => '39.99',
				'dynamic' => [
					'active' => true,
		...
		$this->add_control(
			'currency_format',
			[
				'label' => __( 'Currency Format', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'' => '1,234.56 (Default)',
					',' => '1.234,56',
		...
		$this->add_control(
			'sale',
			[
				'label' => __( 'Sale', 'elementor-avator' ),
		...
		$this->add_control(
			'original_price',
			[
				'label' => __( 'Original Price', 'elementor-avator' ),
		...
		$this->add_control(
			'period',
			[
				'label' => __( 'Period', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Monthly', 'elementor-avator' ),
			]
		);
		...
		$this->start_controls_section(
			'section_features',
			[
				'label' => __( 'Features', 'elementor-avator' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXT,
				'default' => __( 'List Item', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'item_text' => __( 'List Item #1', 'elementor-avator' ),
						'selected_item_icon' => $default_icon,
					],
					[
						'item_text' => __( 'List Item #2', 'elementor-avator' ),
						'selected_item_icon' => $default_icon,
					],
					[
						'item_text' => __( 'List Item #3', 'elementor-avator' ),
						'selected_item_icon' => $default_icon,
					],
				],
		...
		$this->start_controls_section(
			'section_footer',
			[
				'label' => __( 'Footer', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Additional Info', 'elementor-avator' ),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( 'This is text element', 'elementor-avator' ),
				'rows' => 3,
			]
		);
		...
		$this->start_controls_section(
			'section_ribbon',
			[
				'label' => __( 'Ribbon', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'show_ribbon',
			[
				'label' => __( 'Show', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'separator' => 'before',
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Title', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Popular', 'elementor-avator' ),
				'condition' => [
					'show_ribbon' => 'yes',
				],
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Sub Title', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'before' => [
						'title' => __( 'Before', 'elementor-avator' ),
						'icon' => 'eicon-h-align-left',
					],
					'after' => [
						'title' => __( 'After', 'elementor-avator' ),
						'icon' => 'eicon-h-align-right',
					],
				],
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Fractional Part', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => false,
				'options' => [
					'below' => __( 'Below', 'elementor-avator' ),
					'beside' => __( 'Beside', 'elementor-avator' ),
				],
				'default' => 'below',
				'condition' => [
					'period!' => '',
