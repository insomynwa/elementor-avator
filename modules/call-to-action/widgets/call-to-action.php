<?php
namespace ElementorAvator\Modules\CallToAction\Widgets;
...
class Call_To_Action extends Base_Widget {
	...
	public function get_title() {
		return __( 'Call to Action', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'cover' => __( 'Cover', 'elementor-avator' ),
				],
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					...
					'above' => [
						'title' => __( 'Above', 'elementor-avator' ),
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Image Resolution', 'elementor-avator' ),
				'default' => 'large',
				'condition' => [
					'bg_image[id]!' => '',
				],
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => __( 'Colors', 'elementor-avator' ),
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'title_color',
			[
				'label' => __( 'Title Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'description_color',
			[
				'label' => __( 'Description Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'button_color',
			[
				'label' => __( 'Button Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Typography', 'elementor-avator' ),
		...
		$this->start_controls_section(
			'hover_effects',
			[
				'label' => __( 'Hover Effects', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'effect_duration',
			[
				'label' => __( 'Transition Duration', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'render_type' => 'template',
				'default' => [
					'size' => 1500,
