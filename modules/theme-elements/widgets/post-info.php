...
class Post_Info extends Base {
	...
	public function get_title() {
		return __( 'Post Info', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => __( 'Default', 'elementor-avator' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'inline' => [
						'title' => __( 'Inline', 'elementor-avator' ),
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'date',
				'options' => [
					'author' => __( 'Author', 'elementor-avator' ),
					'date' => __( 'Date', 'elementor-avator' ),
					'time' => __( 'Time', 'elementor-avator' ),
					'comments' => __( 'Comments', 'elementor-avator' ),
					'terms' => __( 'Terms', 'elementor-avator' ),
		...
		$repeater->add_control(
			'date_format',
			[
				'label' => __( 'Date Format', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'label_block' => false,
				'default' => 'default',
				'options' => [
					'default' => 'Default',
					'0' => _x( 'March 6, 2018 (F j, Y)', 'Date Format', 'elementor-avator' ),
					'1' => '2018-03-06 (Y-m-d)',
					'2' => '03/06/2018 (m/d/Y)',
					'3' => '06/03/2018 (d/m/Y)',
					'custom' => __( 'Custom', 'elementor-avator' ),
		...
		$repeater->add_control(
			'custom_date_format',
			[
				'label' => __( 'Custom Date Format', 'elementor-avator' ),
				...
				'description' => sprintf(
					...
					__( 'Use the letters: %s', 'elementor-avator' ),
		...
		$repeater->add_control(
			'time_format',
			[
				'label' => __( 'Time Format', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'label_block' => false,
				'default' => 'default',
				'options' => [
		...
		$repeater->add_control(
			'custom_time_format',
			[
				'label' => __( 'Custom Time Format', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'g:i a',
				'placeholder' => 'g:i a',
				'label_block' => false,
		...
		$repeater->add_control(
			'taxonomy',
			[
				'label' => __( 'Taxonomy', 'elementor-avator' ),
		...
		$repeater->add_control(
			'string_no_comments',
			[
				'label' => __( 'No Comments', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'placeholder' => __( 'No Comments', 'elementor-avator' ),
				'condition' => [
		...
		$repeater->add_control(
			'string_one_comment',
			[
				'label' => __( 'One Comment', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'placeholder' => __( 'One Comment', 'elementor-avator' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			'string_comments',
			[
				'label' => __( 'Comments', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => false,
				'placeholder' => __( '%s Comments', 'elementor-avator' ),
				'condition' => [
					'comments_custom_strings' => 'yes',
					'type' => 'comments',
				],
		...
		$repeater->add_control(
			'custom_url',
			[
				'label' => __( 'Custom URL', 'elementor-avator' ),
		...
		$repeater->add_control(
			'selected_icon',
			[
				'label' => __( 'Choose Icon', 'elementor-avator' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options' => [
					'left' => [
						'title' => __( 'Start', 'elementor-avator' ),
	...
	protected function get_meta_data( $repeater_item ) {
		...
		switch ( $repeater_item['type'] ) {
			...
			case 'comments':
				if ( comments_open() ) {
					$default_strings = [
						'string_no_comments' => __( 'No Comments', 'elementor-avator' ),
						'string_one_comment' => __( 'One Comment', 'elementor-avator' ),
						'string_comments' => __( '%s Comments', 'elementor-avator' ),
					];
					...
					if ( 0 === $num_comments ) {
						...
						$item_data['text'] = sprintf( _n( $default_strings['string_one_comment'], $default_strings['string_comments'], $num_comments, 'elementor-avator' ), $num_comments );
					}
