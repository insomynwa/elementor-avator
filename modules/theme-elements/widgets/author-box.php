...
class Author_Box extends Base {
	...
	public function get_title() {
		return __( 'Author Box', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_author_info',
			[
				'label' => __( 'Author Info', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'current',
				'options' => [
					'current' => __( 'Current Author', 'elementor-avator' ),
		...
		$this->add_control(
			'show_avatar',
			[
				'label' => __( 'Profile Picture', 'elementor-avator' ),
		...
		$this->add_control(
			'show_name',
			[
				'label' => __( 'Display Name', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'author_name',
			[
				'label' => __( 'Name', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'website' => __( 'Website', 'elementor-avator' ),
					'posts_archive' => __( 'Posts Archive', 'elementor-avator' ),
				],
				'condition' => [
					'source!' => 'custom',
				],
				'description' => __( 'Link for the Author Name and Image', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'show_biography',
			[
				'label' => __( 'Biography', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'show_link',
			[
				'label' => __( 'Archive Button', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'link_text',
			[
				'label' => __( 'Archive Text', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'All Posts', 'elementor-avator' ),
			]
		);
		...
		$this->add_responsive_control(
			'image_size',
			[
				'label' => __( 'Image Size', 'elementor-avator' ),
