...
class Sitemap extends Base {
	...
	public function get_title() {
		return __( 'Sitemap', 'elementor-avator' );
	}
	...
	private function register_sitemap_tab() {
		$this->start_controls_section(
			'sitemap_section',
			[
				'label' => __( 'Sitemap', 'elementor-avator' ),
	...
	private function register_additional_settings_section() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Protected Posts', 'elementor-avator' ),
	...
	private function register_layout_controls() {
		...
		$this->add_control(
			'sitemap_title_tag',
			[
				'label' => __( 'Title HTML Tag', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'h1' => 'H1',
					'h2' => 'H2',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Add nofollow', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
			]
		);
	}
	...
	private function register_post_type_controls() {
		...
		$repeater->add_control(
			...
			[
				...
				'default' => 'post_type',
				'options' => [
					'post_type' => __( 'Post Type', 'elementor-avator' ),
					'taxonomy' => __( 'Taxonomy', 'elementor-avator' ),
				],
			]
		);
		...
		$repeater->add_control(
			'sitemap_depth',
			[
				'label' => __( 'Depth', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => '0',
				'options' => [
					'0' => __( 'All', 'elementor-avator' ),
					'1' => 1,
					'2' => 2,
					'3' => 3,
					'4' => 4,
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'sitemap_type_selector' => 'post_type',
						'sitemap_title' => __( 'Pages', 'elementor-avator' ),
						'sitemap_source_post_type' => 'page',
					],
					[
						'sitemap_type_selector' => 'taxonomy',
						'sitemap_title' => __( 'Categories', 'elementor-avator' ),
	...
	private function register_style_tab() {
		...
		$this->add_control(
			'sitemap_list_style',
			[
				'label' => __( 'List Item', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Bullet', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'disc' => [
						'title' => __( 'Disc', 'elementor-avator' ),
						'icon' => 'eicon-circle',
					],
					'circle' => [
						'title' => __( 'Circle', 'elementor-avator' ),
						'icon' => 'eicon-circle-o',
					],
					'square' => [
						'title' => __( 'Square', 'elementor-avator' ),
						'icon' => 'eicon-square',
					],
					'none' => [
	...
	private function render_sitemap_item( $sitemap_item, $title_tag, $query_args ) {
		...
		if ( empty( $items_html ) ) {
			$html .= sprintf( '<span %s>%s</span>', $this->get_render_attribute_string( 'list' . $item_type ), __( 'None', 'elementor-avator' ) );
		} else {
