...
class Breadcrumbs extends Base {
	...
	public function get_title() {
		return __( 'Breadcrumbs', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Breadcrumbs', 'elementor-avator' ),
			]
		);
		...
		if ( ! $this->is_breadcrumbs_enabled() ) {
			$this->add_control(
				'html_disabled_alert',
				[
					'raw' => __( 'Breadcrumbs are disabled in the Yoast SEO', 'elementor-avator' ) . ' ' . sprintf( '<a href="%s" target="_blank">%s</a>', admin_url( 'admin.php?page=wpseo_titles#top#breadcrumbs' ), __( 'Breadcrumbs Panel', 'elementor-avator' ) ),
		...
		$this->add_control(
			'html_description',
			[
				'raw' => __( 'Additional settings are available in the Yoast SEO', 'elementor-avator' ) . ' ' . sprintf( '<a href="%s" target="_blank">%s</a>', admin_url( 'admin.php?page=wpseo_titles#top#breadcrumbs' ), __( 'Breadcrumbs Panel', 'elementor-avator' ) ),
				'type' => Controls_Manager::RAW_HTML,
		...
		$this->add_control(
			'link_color',
			[
				'label' => __( 'Link Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
