...
class Post_Navigation extends Base {
	...
	public function get_title() {
		return __( 'Post Navigation', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Post Navigation', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'prev_label',
			[
				'label' => __( 'Previous Label', 'elementor-avator' ),
		...
		$this->add_control(
			'next_label',
			[
				'label' => __( 'Next Label', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'arrow',
			[
				'label' => __( 'Arrows Type', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'fa fa-angle-left' => __( 'Angle', 'elementor-avator' ),
					'fa fa-angle-double-left' => __( 'Double Angle', 'elementor-avator' ),
					'fa fa-chevron-left' => __( 'Chevron', 'elementor-avator' ),
					'fa fa-chevron-circle-left' => __( 'Chevron Circle', 'elementor-avator' ),
					'fa fa-caret-left' => __( 'Caret', 'elementor-avator' ),
					'fa fa-arrow-left' => __( 'Arrow', 'elementor-avator' ),
					'fa fa-long-arrow-left' => __( 'Long Arrow', 'elementor-avator' ),
					'fa fa-arrow-circle-left' => __( 'Arrow Circle', 'elementor-avator' ),
					'fa fa-arrow-circle-o-left' => __( 'Arrow Circle Negative', 'elementor-avator' ),
				],
		...
		$this->add_control(
			'show_title',
			[
				'label' => __( 'Post Title', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'elementor-avator' ),
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'default' => 'yes',
		...
		$this->add_control(
			'show_borders',
			[
				'label' => __( 'Borders', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'elementor-avator' ),
				'label_off' => __( 'Hide', 'elementor-avator' ),
				'default' => 'yes',
		...
		$this->add_control(
			'in_same_term',
			[
				'label' => __( 'In same Term', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT2,
				'options' => $post_type_options,
				'default' => '',
				'multiple' => true,
				'label_block' => true,
				'description' => __( 'Indicates whether next post must be within the same taxonomy term as the current post, this lets you set a taxonomy per each post type', 'elementor-avator' ),
			]
		);
		...
		foreach ( $post_type_options as $post_type => $post_type_label ) {
			$this->add_control(
				$post_type . '_taxonomy',
				[
					'label' => $post_type_label . ' ' . __( 'Taxonomy', 'elementor-avator' ),
					'type' => Controls_Manager::SELECT,
		...
		$this->start_controls_section(
			'arrow_style',
			[
				'label' => __( 'Arrow', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'show_arrow' => 'yes',
				],
	...
	protected function render() {
		...
		if ( 'yes' === $settings['show_arrow'] ) {
			...
			$prev_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-prev"><i class="' . $prev_icon_class . '" aria-hidden="true"></i><span class="elementor-screen-only">' . esc_html__( 'Prev', 'elementor-avator' ) . '</span></span>';
			$next_arrow = '<span class="post-navigation__arrow-wrapper post-navigation__arrow-next"><i class="' . $next_icon_class . '" aria-hidden="true"></i><span class="elementor-screen-only">' . esc_html__( 'Next', 'elementor-avator' ) . '</span></span>';
		}
