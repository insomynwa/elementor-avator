<?php
namespace ElementorAvator\Modules\FlipBox\Widgets;
...
class Flip_Box extends Base_Widget {
	...
	public function get_title() {
		return __( 'Flip Box', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Front', 'elementor-avator' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'elementor-avator' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'icon' => [
						'title' => __( 'Icon', 'elementor-avator' ),
						'icon' => 'eicon-star',
					],
				],
				'default' => 'icon',
		...
		$this->add_control(
			'image',
			[
				'label' => __( 'Choose Image', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'circle' => __( 'Circle', 'elementor-avator' ),
					'square' => __( 'Square', 'elementor-avator' ),
				],
				'default' => 'circle',
				'condition' => [
					'icon_view!' => 'default',
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'This is the heading', 'elementor-avator' ),
				'placeholder' => __( 'Enter your title', 'elementor-avator' ),
				'dynamic' => [
					'active' => true,
				],
				'label_block' => true,
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'elementor-avator' ),
				'placeholder' => __( 'Enter your description', 'elementor-avator' ),
				'separator' => 'none',
				'dynamic' => [
					'active' => true,
				],
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'elementor-avator' ) ] );
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back', 'elementor-avator' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'elementor-avator' ) ] );
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'box' => __( 'Whole Box', 'elementor-avator' ),
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'elementor-avator' ) ] );
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => __( 'Flip Effect', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => __( 'Flip Direction', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
					'left' => __( 'Left', 'elementor-avator' ),
					'right' => __( 'Right', 'elementor-avator' ),
		...
		$this->add_control(
			'flip_3d',
			[
				'label' => __( '3D Depth', 'elementor-avator' ),
		...
		$this->add_control(
			'image_opacity',
			[
				'label' => __( 'Opacity', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
		...
		$this->add_control(
			'icon_padding',
			[
				'label' => __( 'Icon Padding', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->add_control(
			'icon_rotate',
			[
				'label' => __( 'Icon Rotate', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 0,
					'unit' => 'deg',
