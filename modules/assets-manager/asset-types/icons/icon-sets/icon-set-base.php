...
abstract class Icon_Set_Base {
	...
	protected function get_file_url( $file_name ) {
		 ...
		 */
		$url = apply_filters( 'elementor_avator/icons_manager/custom_icons/url', $url, $file_name );
	...
	protected function get_icon_sets_dir() {
		 ...
		 * @param string $path .
		 */
		$path = apply_filters( 'elementor_avator/icons_manager/custom_icons/dir', $path );
