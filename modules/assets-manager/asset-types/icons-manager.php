...
class Icons_Manager {
	...
	public function post_updated_messages( $messages ) {
		$messages[ self::CPT ] = [
			...
			1 => __( 'Icon Set updated.', 'elementor-avator' ),
			2 => __( 'Custom field updated.', 'elementor-avator' ),
			3 => __( 'Custom field deleted.', 'elementor-avator' ),
			4 => __( 'Icon Set updated.', 'elementor-avator' ),
			/* translators: %s: date and time of the revision */
			5 => isset( $_GET['revision'] ) ? sprintf( __( 'Icon Set restored to revision from %s', 'elementor-avator' ), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
			6 => __( 'Icon Set saved.', 'elementor-avator' ),
			7 => __( 'Icon Set saved.', 'elementor-avator' ),
			8 => __( 'Icon Set submitted.', 'elementor-avator' ),
			9 => __( 'Icon Set updated.', 'elementor-avator' ),
			10 => __( 'Icon Set draft updated.', 'elementor-avator' ),
		];
	...
	public function register_admin_menu() {
		$menu_title = _x( 'Custom Icons', 'Elementor Font', 'elementor-avator' );
		add_submenu_page(
			Settings::PAGE_ID,
			$menu_title,
			$menu_title,
	...
	public function add_finder_item( array $categories ) {
		$categories['settings']['items']['custom-icons'] = [
			'title' => __( 'Custom Icons', 'elementor-avator' ),
			'icon' => 'favorite',
	...
	protected function actions() {
		 ...
		 */
		do_action( 'elementor_avator/icons_manager_loaded', $this );
	}
