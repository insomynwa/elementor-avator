<?php
namespace ElementorAvator\Modules\GlobalWidget;
...
class Module extends Module_Base {
	...
	public function add_templates_localize_data( $settings ) {
		...
		$settings = array_replace_recursive( $settings, [
			...
			'i18n' => [
				'unlink' => __( 'Unlink', 'elementor-avator' ),
				'cancel' => __( 'Cancel', 'elementor-avator' ),
				'unlink_widget' => __( 'Unlink Widget', 'elementor-avator' ),
				'global' => __( 'Global', 'elementor-avator' ),
				'dialog_confirm_unlink' => __( 'This will make the widget stop being global. It\'ll be reverted into being just a regular widget.', 'elementor-avator' ),
				'global_widget_save_title' => __( 'Save your widget as a global widget', 'elementor-avator' ),
				'global_widget_save_description' => __( 'You\'ll be able to add this global widget to multiple areas on your site, and edit it from one single place.', 'elementor-avator' ),
				'linked_to_global' => __( 'Linked to Global', 'elementor-avator' ),
			],
		] );
	...
	private function add_hooks() {
		...
		add_filter( 'elementor_avator/editor/localize_settings', [ $this, 'add_templates_localize_data' ] );
