<?php
namespace ElementorAvator\Modules\RoleManager;
...
class Module extends Module_Base {
	...
	public function display_role_controls( $role_slug, $role_data ) {
		...
		<label for="<?php echo esc_attr( $id ); ?>">
			...
			<?php esc_html_e( 'Access to edit content only', 'elementor-avator' ); ?>
		</label>
		<?php
	}
	...
	public function __construct() {
		...
		remove_action( 'elementor/role/restrictions/controls', [ Plugin::elementor()->role_manager, 'get_go_avator_link_html' ] );
