...
class Testimonial_Carousel extends Base {
	...
	public function get_title() {
		return __( 'Testimonial Carousel', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'image_inline' => __( 'Image Inline', 'elementor-avator' ),
					'image_stacked' => __( 'Image Stacked', 'elementor-avator' ),
					'image_above' => __( 'Image Above', 'elementor-avator' ),
					'image_left' => __( 'Image Left', 'elementor-avator' ),
					'image_right' => __( 'Image Right', 'elementor-avator' ),
				],
		...
		$this->start_controls_section(
			'section_skin_style',
			[
				'label' => __( 'Bubble', 'elementor-avator' ),
	...
	protected function add_repeater_controls( Repeater $repeater ) {
		...
		$repeater->add_control(
			...
			[
				'label' => __( 'Title', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'CEO', 'elementor-avator' ),
			]
		);
	}
