...
class Reviews extends Base {
	...
	public function get_title() {
		return __( 'Reviews', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'show_separator',
			[
				'label' => __( 'Separator', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Review', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'default',
				'options' => [
					'default' => __( 'Official', 'elementor-avator' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Rating', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'unmarked_star_style',
			[
				'label' => __( 'Unmarked Style', 'elementor-avator' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'solid' => [
						'title' => __( 'Solid', 'elementor-avator' ),
						'icon' => 'eicon-star',
					],
					'outline' => [
						'title' => __( 'Outline', 'elementor-avator' ),
						'icon' => 'eicon-star-o',
					],
				],
				'default' => 'solid',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Unmarked Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function get_repeater_defaults() {
		...
		return [
			[
				'content' => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'elementor-avator' ),
				'name' => __( 'John Doe', 'elementor-avator' ),
				'title' => '@username',
				'image' => [
	...
	private function print_icon( $slide, $element_key ) {
		...
		$icon .= '<span class="elementor-screen-only">' . esc_html__( 'Read More', 'elementor-avator' ) . '</span>';
