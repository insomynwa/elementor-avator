<?php
namespace ElementorAvator\Modules\Carousel\Widgets;
...
class Media_Carousel extends Base {
	...
	public function get_title() {
		return __( 'Media Carousel', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Lightbox', 'elementor-avator' ),
		...
		$this->add_control(
			'lightbox_ui_color',
			[
				'label' => __( 'UI Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'UI Hover Color', 'elementor-avator' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Video Width', 'elementor-avator' ),
	...
	protected function add_repeater_controls( Repeater $repeater ) {
		...
		$repeater->add_control(
			'video',
			[
				'label' => __( 'Video Link', 'elementor-avator' ),
				'type' => Controls_Manager::URL,
				'placeholder' => __( 'Enter your video link', 'elementor-avator' ),
				'description' => __( 'YouTube or Vimeo link', 'elementor-avator' ),
				'show_external' => false,
				'condition' => [
					'type' => 'video',
				],
		...
		<div <?php echo $this->get_render_attribute_string( $element_key . '-image' ); ?>>
			<?php if ( 'video' === $slide['type'] && $settings['video_play_icon'] ) : ?>
				<div class="elementor-custom-embed-play">
					...
					<span class="elementor-screen-only"><?php _e( 'Play', 'elementor-avator' ); ?></span>
				</div>
			<?php endif; ?>
		</div>
	...
	private function add_injections() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'carousel',
				'options' => [
					'carousel' => __( 'Carousel', 'elementor-avator' ),
					'slideshow' => __( 'Slideshow', 'elementor-avator' ),
					'coverflow' => __( 'Coverflow', 'elementor-avator' ),
				],
		...
		$this->add_control(
			'image_fit',
			[
				'label' => __( 'Image Fit', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => __( 'Cover', 'elementor-avator' ),
					'contain' => __( 'Contain', 'elementor-avator' ),
					'auto' => __( 'Auto', 'elementor-avator' ),
				],
				'selectors' => [
		...
		$this->add_control(
			'play_icon_title',
			[
				'label' => __( 'Play Icon', 'elementor-avator' ),
		...
		$this->add_group_control(
			...
			[
				...
				'fields_options' => [
					'text_shadow_type' => [
						'label' => _x( 'Shadow', 'Text Shadow Control', 'elementor-avator' ),
					],
				],
			]
		);
		...
		$this->add_control(
			'thumbs_title',
			[
				'label' => __( 'Thumbnails', 'elementor-avator' ),
				'type' => Controls_Manager::HEADING,
				'condition' => [
					'skin' => 'slideshow',
				],
		...
		$this->add_control(
			'thumbs_ratio',
			[
				'label' => __( 'Ratio', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => '219',
				'options' => [
					'169' => '16:9',
		...
		$this->add_control(
			'centered_slides',
			[
				'label' => __( 'Centered Slides', 'elementor-avator' ),
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SELECT,
				'label' => __( 'Slides Per View', 'elementor-avator' ),
				'options' => [ '' => __( 'Default', 'elementor-avator' ) ] + $slides_per_view,
				'condition' => [
					'skin' => 'slideshow',
				],
				'frontend_available' => true,
