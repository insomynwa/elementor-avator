	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Effect', 'elementor-avator' ),
				'default' => 'slide',
				'options' => [
					'slide' => __( 'Slide', 'elementor-avator' ),
					'fade' => __( 'Fade', 'elementor-avator' ),
					'cube' => __( 'Cube', 'elementor-avator' ),
				],
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SELECT,
				'label' => __( 'Slides to Scroll', 'elementor-avator' ),
				'description' => __( 'Set how many slides are scrolled per swipe.', 'elementor-avator' ),
				'options' => [ '' => __( 'Default', 'elementor-avator' ) ] + $slides_per_view,
				'condition' => [
					'effect' => 'slide',
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'bullets' => __( 'Dots', 'elementor-avator' ),
					'fraction' => __( 'Fraction', 'elementor-avator' ),
					'progressbar' => __( 'Progress', 'elementor-avator' ),
				],
