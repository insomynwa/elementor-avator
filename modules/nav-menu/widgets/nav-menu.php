<?php
namespace ElementorAvator\Modules\NavMenu\Widgets;
...
class Nav_Menu extends Widget_Base {
	...
	public function get_title() {
		return __( 'Nav Menu', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				'menu',
				[
					'label' => __( 'Menu', 'elementor-avator' ),
					'type' => Controls_Manager::SELECT,
					'options' => $menus,
					'default' => array_keys( $menus )[0],
					'save_default' => true,
					'separator' => 'after',
					'description' => sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'elementor-avator' ), admin_url( 'nav-menus.php' ) ),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __( 'There are no menus in your site.', 'elementor-avator' ) . '</strong><br>' . sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'elementor-avator' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator' => 'after',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'options' => [
					'horizontal' => __( 'Horizontal', 'elementor-avator' ),
					'vertical' => __( 'Vertical', 'elementor-avator' ),
					'dropdown' => __( 'Dropdown', 'elementor-avator' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'justify' => [
						'title' => __( 'Stretch', 'elementor-avator' ),
		...
		$this->add_control(
			'indicator',
			[
				'label' => __( 'Submenu Indicator', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'classic',
				'options' => [
					'none' => __( 'None', 'elementor-avator' ),
					'classic' => __( 'Classic', 'elementor-avator' ),
					'chevron' => __( 'Chevron', 'elementor-avator' ),
					'angle' => __( 'Angle', 'elementor-avator' ),
					'plus' => __( 'Plus', 'elementor-avator' ),
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Mobile Dropdown', 'elementor-avator' ),
		...
		$this->add_control(
			'dropdown',
			[
				'label' => __( 'Breakpoint', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'tablet',
				'options' => [
		...
		$this->add_control(
			'full_width',
			[
				'label' => __( 'Full Width', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => __( 'Stretch the dropdown of the menu to full width.', 'elementor-avator' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'aside',
				'options' => [
					'aside' => __( 'Aside', 'elementor-avator' ),
		...
		$this->add_control(
			'toggle',
			[
				'label' => __( 'Toggle Button', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'burger',
				'options' => [
					'' => __( 'None', 'elementor-avator' ),
					'burger' => __( 'Hamburger', 'elementor-avator' ),
				],
		...
		$this->add_control(
			'toggle_align',
			[
				'label' => __( 'Toggle Align', 'elementor-avator' ),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'center',
				'options' => [
					'left' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Main Menu', 'elementor-avator' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Dropdown', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'condition' => [
					'dropdown!' => 'none',
				],
		...
		$this->add_control(
			...
			[
				'raw' => __( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'elementor-avator' ),
				'type' => Controls_Manager::RAW_HTML,
	...
	protected function render() {
		...
		$this->add_render_attribute( 'menu-toggle', [
			...
			'role' => 'button',
			'tabindex' => '0',
			'aria-label' => __( 'Menu Toggle', 'elementor-avator' ),
			'aria-expanded' => 'false',
		] );
		...
		<div <?php echo $this->get_render_attribute_string( 'menu-toggle' ); ?>>
			...
			<span class="elementor-screen-only"><?php _e( 'Menu', 'elementor-avator' ); ?></span>
		</div>
