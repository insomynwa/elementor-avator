<?php
namespace ElementorAvator\Modules\CustomAttributes;
...
class Module extends Module_Base {
	...
	private function get_black_list_attributes() {
		...
		if ( null === $black_list ) {
			 ...
			 */
			$black_list = apply_filters( 'elementor_avator/element/attributes/black_list', $black_list );
		}
	...
	public function register_controls( Controls_Stack $element, $section_id ) {
		...
		$element->start_controls_section(
			'_section_attributes',
			[
				'label' => __( 'Attributes', 'elementor-avator' ),
		...
		$element->add_control(
			'_attributes',
			[
				'label' => __( 'Custom Attributes', 'elementor-avator' ),
				'type' => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => __( 'key|value', 'elementor-avator' ),
				'description' => sprintf( __( 'Set custom attributes for the wrapper element. Each attribute in a separate line. Separate attribute key from the value using %s character.', 'elementor-avator' ), '<code>|</code>' ),
