<?php
namespace ElementorAvator\Modules\AnimatedHeadline\Widgets;
...
class Animated_Headline extends Base_Widget {
	...
	public function get_title() {
		return __( 'Animated Headline', 'elementor-avator' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'text_elements',
			[
				'label' => __( 'Headline', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => 'highlight',
				'options' => [
					'highlight' => __( 'Highlighted', 'elementor-avator' ),
					'rotate' => __( 'Rotating', 'elementor-avator' ),
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => 'circle',
				'options' => [
					'circle' => _x( 'Circle', 'Shapes', 'elementor-avator' ),
					'curly' => _x( 'Curly', 'Shapes', 'elementor-avator' ),
					'underline' => _x( 'Underline', 'Shapes', 'elementor-avator' ),
					'double' => _x( 'Double', 'Shapes', 'elementor-avator' ),
					'double_underline' => _x( 'Double Underline', 'Shapes', 'elementor-avator' ),
					'underline_zigzag' => _x( 'Underline Zigzag', 'Shapes', 'elementor-avator' ),
					'diagonal' => _x( 'Diagonal', 'Shapes', 'elementor-avator' ),
					'strikethrough' => _x( 'Strikethrough', 'Shapes', 'elementor-avator' ),
					'x' => 'X',
				],
				'render_type' => 'template',
				'condition' => [
		...
		$this->add_control(
			'before_text',
			[
				'label' => __( 'Before Text', 'elementor-avator' ),
				...
				'default' => __( 'This page is', 'elementor-avator' ),
				'placeholder' => __( 'Enter your headline', 'elementor-avator' ),
				'label_block' => true,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'highlighted_text',
			[
				'label' => __( 'Highlighted Text', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Amazing', 'elementor-avator' ),
				'label_block' => true,
				'condition' => [
					'headline_style' => 'highlight',
				],
		...
		$this->add_control(
			'rotating_text',
			[
				'label' => __( 'Rotating Text', 'elementor-avator' ),
				'type' => Controls_Manager::TEXTAREA,
				'placeholder' => __( 'Enter each word in a separate line', 'elementor-avator' ),
				'separator' => 'none',
				'default' => "Better\nBigger\nFaster",
				'condition' => [
					'headline_style' => 'rotate',
		...
		$this->add_control(
			'after_text',
			[
				'label' => __( 'After Text', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
					'categories' => [
		...
		$this->add_control(
			'above_content',
			[
				'label' => __( 'Bring to Front', 'elementor-avator' ),
		...
		$this->add_control(
			'rounded_edges',
			[
				'label' => __( 'Rounded Edges', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'label' => __( 'Animated Text', 'elementor-avator' ),
				'separator' => 'before',
			]
		);
