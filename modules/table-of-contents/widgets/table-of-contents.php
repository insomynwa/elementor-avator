<?php
namespace ElementorAvator\Modules\TableOfContents\Widgets;
...
class Table_Of_Contents extends Base_Widget {
	...
	public function get_title() {
		return __( 'Table of Contents', 'elementor-avator' );
	}
	...
	public function get_categories() {
		return [ 'avator-elements', 'theme-elements-single' ];
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'table_of_contents',
			[
				'label' => __( 'Table of Contents', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => __( 'Table of Contents', 'elementor-avator' ),
			]
		);
		...
		$this->add_control(
			'html_tag',
			[
				'label' => __( 'HTML Tag', 'elementor-avator' ),
		...
		$this->add_control(
			'headings_by_tags',
			[
				'label' => __( 'Anchors By Tags', 'elementor-avator' ),
		...
		$this->add_control(
			'container',
			[
				'label' => __( 'Container', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'description' => __( 'This control confines the Table of Contents to heading elements under a specific container', 'elementor-avator' ),
				'frontend_available' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Anchors By Selector', 'elementor-avator' ),
				'type' => Controls_Manager::TEXT,
				'description' => __( 'CSS selectors, in a comma-separated list', 'elementor-avator' ),
				'default' => [],
				'label_block' => true,
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'marker_view',
			[
				'label' => __( 'Marker View', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'numbers',
				'options' => [
					'numbers' => __( 'Numbers', 'elementor-avator' ),
					'bullets' => __( 'Bullets', 'elementor-avator' ),
				],
				'separator' => 'before',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'word_wrap',
			[
				'label' => __( 'Word Wrap', 'elementor-avator' ),
		...
		$this->add_control(
			'minimize_box',
			[
				'label' => __( 'Minimize Box', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'collapse_icon',
			[
				'label' => __( 'Minimize Icon', 'elementor-avator' ),
				'type' => Controls_Manager::ICONS,
				'default' => [
		...
		$this->add_control(
			'minimized_on',
			[
				'label' => __( 'Minimized On', 'elementor-avator' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'tablet',
				'options' => [
					/* translators: %d: Breakpoint number. */
					'mobile' => sprintf( __( 'Mobile (< %dpx)', 'elementor-avator' ), $breakpoints['md'] ),
					/* translators: %d: Breakpoint number. */
					'tablet' => sprintf( __( 'Tablet (< %dpx)', 'elementor-avator' ), $breakpoints['lg'] ),
		...
		$this->add_control(
			'hierarchical_view',
			[
				'label' => __( 'Hierarchical View', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'frontend_available' => true,
			]
		...
		$this->add_control(
			'collapse_subitems',
			[
				'label' => __( 'Collapse Subitems', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'description' => __( 'The "Collapse" option should only be used if the Table of Contents is made sticky', 'elementor-avator' ),
				'condition' => [
		...
		$this->add_responsive_control(
			'min_height',
			[
				'label' => __( 'Min Height', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'vh' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Separator Width', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'selectors' => [
		...
		$this->start_controls_section(
			'list_style',
			[
				'label' => __( 'List', 'elementor-avator' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'list_indent',
			[
				'label' => __( 'Indent', 'elementor-avator' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em' ],
				'default' => [
					'unit' => 'em',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Underline', 'elementor-avator' ),
				'type' => Controls_Manager::SWITCHER,
				'selectors' => [
		...
		$this->add_control(
			'heading_marker',
			[
				'label' => __( 'Marker', 'elementor-avator' ),
