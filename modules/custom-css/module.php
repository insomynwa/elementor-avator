<?php
namespace ElementorAvator\Modules\CustomCss;
...
class Module extends Module_Base {
	...
	public function register_controls( Controls_Stack $element, $section_id ) {
		...
		$this->replace_go_avator_custom_css_controls( $element );
	}
	 ...
	 */
	public function replace_go_avator_custom_css_controls( $controls_stack ) {
		...
		$controls_stack->start_controls_section(
			'section_custom_css',
			[
				'label' => __( 'Custom CSS', 'elementor-avator' ),
				'tab' => $old_section['tab'],
			]
		);
		...
		$controls_stack->add_control(
			'custom_css_title',
			[
				'raw' => __( 'Add your own custom CSS here', 'elementor-avator' ),
		...
		$controls_stack->add_control(
			...
			[
				'raw' => __( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'elementor-avator' ),
				'type' => Controls_Manager::RAW_HTML,
	...
	public function localize_settings( array $settings ) {
		$settings['i18n']['custom_css'] = __( 'Custom CSS', 'elementor-avator' );
