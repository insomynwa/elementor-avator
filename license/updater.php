...
class Updater {
	...
	public function __construct() {
		$this->plugin_version = ELEMENTOR_AVATOR_VERSION;
		$this->plugin_name = ELEMENTOR_AVATOR_PLUGIN_BASE;
		$this->plugin_slug = basename( ELEMENTOR_AVATOR__FILE__, '.php' );
	...
	public function plugins_api_filter( $_data, $_action = '', $_args = null ) {
		...
		$cache_key = 'elementor_avator_api_request_' . substr( md5( serialize( $this->plugin_slug ) ), 0, 15 );
		...
		if ( empty( $api_request_transient ) ) {
			...
			$api_request_transient->name = 'Elementor Avator';
