/*! elementor-avator - v2.10.0 - 13-06-2020 */
...
fetchCache: function fetchCache(type, cacheKey, requestArgs) {
	...
	return elementorAvator.ajax.addRequest('forms_panel_action_data', {
...
var ElementorAvator = Marionette.Application.extend({
config: {},
modules: {},
...
onStart: function onStart() {
	...
	}).on('elementor/connect/success/editor-avator-activate', this.onActivateSuccess);
},
onElementorInit: function onElementorInit() {
	...
	elementorAvator.libraryRemoveGetProButtons();
	elementor.debug.addURLToWatch('elementor-avator/assets');
},
onElementorPreviewLoaded: function onElementorPreviewLoaded() {
	elementor.$preview[0].contentWindow.elementorAvator = this;
},
libraryRemoveGetProButtons: function libraryRemoveGetProButtons() {
	...
	return templateData.isPro && !elementorAvator.config.isActive ? '#tmpl-elementor-avator-template-library-activate-license-button' : '#tmpl-elementor-template-library-insert-button';
	});
},
onActivateSuccess: function onActivateSuccess() {
	...
	elementorAvator.config.isActive = true;
	elementor.notifications.showToast({
	message: elementor.translate('connected_successfully')
	});
}
});
window.elementorAvator = new ElementorAvator();
elementorAvator.start();
...
(0, _createClass2.default)(_default, [{
	...
	elementor.navigator.indicators.motionFX = {
		icon: 'flash',
		title: elementorAvator.translate('motion_effects'),
...
(0, _createClass2.default)(PopupSave, [{
	...
	return 'elementor-avator-popup-save';
	}
}, {
	key: "getConditions",
	...
	var settings = {};
	jQuery.each(elementorAvator.modules.popup.displaySettingsTypes, function (type, data) {
		settings[type] = data.model.toJSON({
		remove: ['default']
		});
	});
	elementorAvator.ajax.addRequest('popup_save_display_settings', {
		data: {
		settings: settings
		}
	});
...
(0, _createClass2.default)(PopupAddInstructions, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-popup-add-instructions';
	}
}, {
	key: "getConditions",
	...
	return new elementorModules.editor.utils.Introduction({
		...
		headerMessage: '<i class="eicon-info"></i>' + elementorAvator.translate('popup_settings_introduction_title'),
		message: elementorAvator.translate('popup_settings_introduction_message'),
		closeButton: true,
...
(0, _createClass2.default)(PopupAddLibraryTab, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-popup-add-library-tab';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
	...
	$e.components.get('library').addTab('templates/popups', {
		title: elementorAvator.translate('popups'),
		filter: {
		source: 'remote',
		type: 'popup'
		}
...
(0, _createClass2.default)(PopupAddTriggers, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-popup-add-triggers';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
	...
	var config = elementor.config.document.displaySettings,
		...
		module = elementorAvator.modules.popup;
	jQuery.each(module.displaySettingsTypes, function (type, data) {
		...
		name: type,
		title: elementorAvator.translate(type),
		description: elementorAvator.translate("popup_publish_screen_".concat(type, "_description")),
		image: elementorAvator.config.urls.modules + "popup/assets/images/".concat(type, "-tab.svg")
		});
	});
	}
}, {
	...
	var component = $e.components.get('theme-builder-publish'),
		displaySettingsTypes = elementorAvator.modules.popup.displaySettingsTypes;
...
(0, _createClass2.default)(_default, [{
	...
	this.children.each(function (child) {
		...
		class: 'elementor-popup__display-settings_controls_group__icon'
			...
			$image = jQuery('<img>', {
		src: elementorAvator.config.urls.modules + "popup/assets/images/".concat(name, "/").concat(groupName, ".svg")
		});
...
(0, _createClass2.default)(PopupRemoveInstructions, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-popup-remove-instructions';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
...
(0, _createClass2.default)(PopupRemoveLibraryTab, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-popup-remove-library-tab';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
...
(0, _createClass2.default)(PopupRemoveTriggers, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-popup-remove-triggers';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
	...
	var displaySettingsTypes = elementorAvator.modules.popup.displaySettingsTypes;
...
(0, _createClass2.default)(Module, [{
	...
	elementor.templates.registerTemplateType('widget', {
		showInLibrary: false,
		saveDialog: {
		title: elementorAvator.translate('global_widget_save_title'),
		description: elementorAvator.translate('global_widget_save_description')
		},
	...
	_.each(elementorAvator.config.widget_templates, function (templateArgs, id) {
...
(0, _createClass2.default)(Link, [{
	...
	return {
		...
		subTitle: data.title,
		type: elementorAvator.translate('linked_to_global')
	};
	}
}, {
	key: "apply",
	...
	container) {
		...
		var globalModel = elementorAvator.modules.globalWidget.addGlobalWidget(data.template_id, data),
...
(0, _createClass2.default)(Unlink, [{
	...
	return {
		...
		type: elementorAvator.translate('unlink_widget')
	};
	}
}, {
	key: "apply",
	...
	/** Container */
	container) {
		var globalModel = elementorAvator.modules.globalWidget.getGlobalModels(container.model.get('templateID'));
		$e.run('document/elements/create', {
		container: container.parent,
		model: {
			id: elementor.helpers.getUniqueID(),
...
(0, _createClass2.default)(GlobalWidgetSave, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-global-widget-save';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
	...
	key: "apply",
	value: function apply() {
	elementorAvator.modules.globalWidget.saveTemplates();
	}
}]);
...
initialize: function initialize() {
	...
	if (!globalSettingsLoadedStatus) {
		...
		elementorAvator.modules.globalWidget.requestGlobalModelSettings(globalModel);
	}
...
getGlobalModel: function getGlobalModel() {
	if (!this.globalModel) {
	this.globalModel = elementorAvator.modules.globalWidget.getGlobalModels(this.model.get('templateID'));
	}
...
getGlobalModel: function getGlobalModel() {
	...
	return elementorAvator.modules.globalWidget.getGlobalModels(templateID);
},
getTitle: function getTitle() {
	...
	var global = elementorAvator.translate('global');
...
buildUnlinkDialog: function buildUnlinkDialog() {
	...
	headerMessage: elementorAvator.translate('unlink_widget'),
	message: elementorAvator.translate('dialog_confirm_unlink'),
	position: {
		my: 'center center',
		at: 'center center'
	},
	strings: {
		confirm: elementorAvator.translate('unlink'),
		cancel: elementorAvator.translate('cancel')
	},
...
onEditButtonClick: function onEditButtonClick() {
	...
	elementorAvator.modules.globalWidget.requestGlobalModelSettings(editedModel, function () {
...
(0, _createClass2.default)(ThemeBuilderModule, [{
	...
	Object.defineProperty(elementorAvator.config, 'theme_builder', {
		get: function get() {
...
(0, _createClass2.default)(_default, [{
	...
	return {
		title: elementorAvator.translate('publish_settings')
	};
	}
}, {
	key: "initModal",
	...
	this.modal.addButton({
		name: 'publish',
		text: elementorAvator.translate('save_and_close'),
		callback: function callback() {
	...
	this.modal.addButton({
		name: 'next',
		text: elementorAvator.translate('next'),
		callback: function callback() {
...
(0, _createClass2.default)(ThemeBuilderSaveAndReload, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-theme-builder-save-and-reload';
	}
}, {
...
(0, _createClass2.default)(ThemeBuilderUpdatePreviewOptions, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-theme-builder-update-preview-options';
	}
}, {
	key: "getContainerType",
	value: function getContainerType() {
	...
	var _args$containers = args.containers,
		containers = _args$containers === void 0 ? [args.container] : _args$containers,
		themeBuilder = elementorAvator.modules.themeBuilder;
...
(0, _createClass2.default)(ThemeBuilderSaveConditions, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-theme-builder-save-conditions';
	}
}, {
	key: "getConditions",
	value: function getConditions() {
	...
	key: "apply",
	value: function apply() {
	var conditionsModel = elementorAvator.modules.themeBuilder.conditionsModel;
	elementorAvator.ajax.addRequest('theme_builder_save_conditions', {
...
(0, _createClass2.default)(ThemeBuilderShowConditions, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-theme-builder-show-conditions';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
...
(0, _createClass2.default)(ThemeBuilderPreviewBreak, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-theme-builder-preview-break';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
...
(0, _createClass2.default)(ThemeBuilderAddEditorUI, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-theme-builder-add-editor-ui';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
	...
	component.addTab('conditions', {
		title: elementorAvator.translate('conditions'),
		View: _view.default,
		viewOptions: {
		...
		name: 'conditions',
		description: elementorAvator.translate('conditions_publish_screen_description'),
		image: elementorAvator.config.urls.modules + 'theme-builder/assets/images/conditions-tab.svg'
	});
	}
}, {
	key: "addPanelFooterSubmenuItems",
	...
	footerView.ui.menuConditions = footerView.addSubMenuItem('saver-options', {
		...
		name: 'conditions',
		icon: 'eicon-flow',
		title: elementorAvator.translate('display_conditions'),
		callback: function callback() {
...
checkConflicts: function checkConflicts(model) {
	...
	$error.remove();
	elementorAvator.ajax.addRequest('theme_builder_conditions_check_conflicts', {
	unique_id: rowId,
	data: {
...
onRender: function onRender() {
	this.ui.btnAddRow.text(elementorAvator.translate('add_condition'));
	var self = this;
...
(0, _createClass2.default)(ThemeBuilderRemoveEditorUI, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-theme-builder-remove-editor-ui';
	}
}, {
	key: "getConditions",
	value: function getConditions(args) {
...
(0, _createClass2.default)(ThemeBuilderToggleMenuConditions, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-theme-builder-toggle-menu-conditions';
	}
}, {
	key: "getContainerType",
	value: function getContainerType() {
	...
	key: "apply",
	value: function apply() {
	var themeBuilder = elementorAvator.modules.themeBuilder;
...
(0, _createClass2.default)(FormFieldsSanitizeCustomId, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-forms-fields-sanitize-custom-id';
	}
}, {
	key: "getContainerType",
	value: function getContainerType() {
...
(0, _createClass2.default)(FormFieldsSetCustomId, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-forms-fields-set-custom-id';
	}
}, {
	key: "getContainerType",
	value: function getContainerType() {
...
(0, _createClass2.default)(FormFieldsAddFirstStep, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-forms-fields-first-step';
	}
}, {
	key: "getContainerType",
	value: function getContainerType() {
...
(0, _createClass2.default)(FormFieldsUpdateShortCode, [{
	...
	key: "getId",
	value: function getId() {
	return 'elementor-avator-forms-fields-update-shortcode';
	}
}, {
	key: "getContainerType",
	value: function getContainerType() {
...
var updateReplyToOptions = function updateReplyToOptions() {
	...
	return {
		...
		label: elementorAvator.translate('x_field', [model.get('field_label')])
	};
	});
...
getDataSettings: function getDataSettings(item) {
	var config = elementorAvator.config.forms[item.field_type],
...
onInit: function onInit() {
	elementor.hooks.addFilter('elementor_avator/forms/content_template/item', this.filterItem);
	elementor.hooks.addFilter('elementor_avator/forms/content_template/field/recaptcha', this.renderField, 10, 2);
	elementor.hooks.addFilter('elementor_avator/forms/content_template/field/recaptcha_v3', this.renderField, 10, 2);
}
});
...
onInit: function onInit() {
	elementor.hooks.addFilter('elementor_avator/forms/content_template/field/time', this.renderField, 10, 4);
}
});
...
onInit: function onInit() {
	elementor.hooks.addFilter('elementor_avator/forms/content_template/field/date', this.renderField, 10, 4);
}
});
...
onInit: function onInit() {
	elementor.hooks.addFilter('elementor_avator/forms/content_template/field/acceptance', this.renderField, 10, 4);
}
});
...
onInit: function onInit() {
	elementor.hooks.addFilter('elementor_avator/forms/content_template/field/upload', this.renderField, 10, 4);
}
});
...
onInit: function onInit() {
	elementor.hooks.addFilter('elementor_avator/forms/content_template/field/tel', this.renderField, 10, 4);
}
});
...
getSelect2Placeholder: function getSelect2Placeholder() {
	return {
	id: '',
	text: elementorAvator.translate('all')
	};
},
...
getSelect2DefaultOptions: function getSelect2DefaultOptions() {
	...
	ajax: {
		...
		return elementorAvator.ajax.addRequest(action, {
			data: data,
			success: success,
			error: failure
		});
...
self.onTemplateIdChange = function () {
	...
	$editButton = jQuery('<a />', {
		...
		href: editUrl,
		html: '<i class="eicon-pencil" /> ' + elementorAvator.config.i18n.edit_template
	});
...
getCustomFont: function getCustomFont(fontType, font) {
	elementorAvator.ajax.addRequest('assets_manager_panel_action_data', {
