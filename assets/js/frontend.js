...
var ElementorAvatorFrontend = /*#__PURE__*/function (_elementorModules$Vie) {
(0, _inherits2.default)(ElementorAvatorFrontend, _elementorModules$Vie);

function ElementorAvatorFrontend() {
	(0, _classCallCheck2.default)(this, ElementorAvatorFrontend);
	return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ElementorAvatorFrontend).apply(this, arguments));
}

(0, _createClass2.default)(ElementorAvatorFrontend, [{
	key: "onInit",
	value: function onInit() {
	(0, _get2.default)((0, _getPrototypeOf2.default)(ElementorAvatorFrontend.prototype), "onInit", this).call(this);
...
(0, _createClass2.default)(lottieHandler, [{
	...
	return elementorAvatorFrontend.config.lottie.defaultAnimationUrl;
	}
}, {
	key: "setCaption",
...
(0, _createClass2.default)(TOCHandler, [{
	...
	var noHeadingsText = elementorAvatorFrontend.config.i18n['toc_no_headings_found'];

	if (elementorFrontend.isEditMode()) {
		noHeadingsText = elementorAvator.translate('toc_no_headings_found');
	}
