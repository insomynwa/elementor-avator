...
/***/ (function(module, exports) {
	...
	function _interopRequireDefault(obj) {
	  ...
	  jQuery(function () {
		elementorAvatorAdmin.roleManager.advancedRoleManager.init();
	  });
	  ...
	  module.exports = function () {
		...
		self.init = function () {
		  jQuery(document).on('change', '.elementor-widget-template-select', function () {
			...
			var editUrl = ElementorAvatorConfig.i18n.home_url + '?p=' + templateID + '&elementor';
	  ...
	  module.exports = function (key, fieldID) {
		...
		self.cacheElements = function () {
		  this.cache = {
			$button: jQuery('#elementor_avator_' + key + '_button'),
			$apiKeyField: jQuery('#elementor_avator_' + key),
			$apiUrlField: jQuery('#elementor_avator_' + fieldID)
		  };
		};
	  ...
	  var _elementorAvatorUpload = _interopRequireDefault(__webpack_require__(113));
	  
	  var _elementorAvatorRepeater = _interopRequireDefault(__webpack_require__(118));
	  ...
	  var CustomFontsManager = /*#__PURE__*/function (_CustomAssetsBase) {
		...
		(0, _createClass2.default)(CustomFontsManager, [{
		  ...
		  value: function getDefaultSettings() {
			return {
			  fields: {
				upload: _elementorAvatorUpload.default,
				repeater: _elementorAvatorRepeater.default
			  },
			  selectors: {
			  ...
			  notice: ElementorAvatorConfig.i18n.fontsUploadEmptyNotice,
	  ...
	  var _elementorAvatorDropzone = _interopRequireDefault(__webpack_require__(120));
	  ...
	  var CustomIcons = /*#__PURE__*/function (_CustomAssetsBase) {
		...
		(0, _createClass2.default)(CustomIcons, [{
		  ...
		  value: function getDefaultSettings() {
			return {
			  fields: {
				dropzone: _elementorAvatorDropzone.default
			  },
			  classes: {
		...
		(0, _createClass2.default)(DropZoneField, [{
		  ...
		  value: function handleUpload() {
			...
			var _this$elements2 = this.elements,
				...
				actionKey = 'avator_assets_manager_custom_icon_upload',
				self = this;
			...
			ajaxData.append('actions', JSON.stringify({
			  avator_assets_manager_custom_icon_upload: {
				action: actionKey,
				data: {
				  post_id: $postId.val()
				}
			...
			elementorCommon.ajax.send('ajax', {
			  ...
			  processData: false,
			  xhr: function xhr() {
				var xhr = jQuery.ajaxSettings.xhr(); //Upload progress
	  
				xhr.upload.onprogress = function (evt) {
				  if (evt.lengthComputable) {
					var percentComplete = Math.round(evt.loaded * 100 / evt.total); //Do something with upload progress
				  }
				};
	  ...
	  module.exports = function () {
		...
		self.cacheElements = function () {
		  this.cache = {
			$button: jQuery('#elementor_avator_typekit_validate_button'),
			$kitIdField: jQuery('#elementor_typekit-kit-id'),
			$dataLabelSpan: jQuery('.elementor-avator-typekit-data')
		  };
		};
		...
		self.fetchFonts = function () {
		  ...
		  jQuery.post(ajaxurl, {
			action: 'elementor_avator_admin_fetch_fonts',
			kit_id: kitID,
			_nonce: self.cache.$button.data('nonce')
		  }).done(function (data) {
			if (data.success) {
	  ...
	  var _default = /*#__PURE__*/function (_elementorModules$Vie) {
		...
		(0, _createClass2.default)(_default, [{
		  ...
		  value: function getDefaultSettings() {
			return {
			  selectors: {
				button: '#elementor_avator_fa_avator_validate_button',
