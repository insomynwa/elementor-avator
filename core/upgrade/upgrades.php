...
class Upgrades {
	...
	public static function _v_2_5_0_form( $updater ) {
		$changes = [
			[
				'callback' => [ 'ElementorAvator\Core\Upgrade\Upgrades', '_rename_repeater_settings' ],
				'control_ids' => [
					'form_fields' => [
						'_id' => 'custom_id',
					],
	...
	public static function _v_2_5_0_woocommerce_menu_cart( $updater ) {
		$changes = [
			[
				'callback' => [ 'ElementorAvator\Core\Upgrade\Upgrades', '_rename_widget_settings' ],
				'control_ids' => [
			...
			[
				'callback' => [ 'ElementorAvator\Core\Upgrade\Upgrades', '_slider_to_border_settings' ],
				'control_ids' => [
	...
	public static function _v_2_5_0_posts( $updater ) {
		...
		$changes = [
			...
			[
				'callback' => [ 'ElementorAvator\Core\Upgrade\Upgrades', '_add_widget_settings_to_array' ],
				'control_ids' => array_merge( $add_taxonomies, [
					'posts_authors' => [ 'posts_include' => 'authors' ],
				] ),
			],
			[
				'callback' => [ 'ElementorAvator\Core\Upgrade\Upgrades', '_merge_widget_settings' ],
	...
	public static function _v_2_5_4_posts( $updater ) {
		...
		$changes = [
			[
				'callback' => [ 'ElementorAvator\Core\Upgrade\Upgrades', '_convert_term_id_to_term_taxonomy_id' ],
				'control_ids' => $merge_taxonomies,
				'prefix' => 'posts_',
	...
	public static function _v_2_5_4_form( $updater ) {
		$changes = [
			[
				'callback' => [ 'ElementorAvator\Core\Upgrade\Upgrades', '_missing_form_custom_id_settings' ],
				'control_ids' => [],
			],
		];
